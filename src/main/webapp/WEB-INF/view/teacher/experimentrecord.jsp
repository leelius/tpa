                            ...
                            <c:if test="${searchpanel=='true'}">
                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <div id="searchPanel"
                                                 <c:if test="${kw != null  || reviewstate_map != null  ||  curriculum_id_map != null  || student_group_id_map != null }">
                                                     class="collapse in form-inline"
                                                 </c:if>
                                                 <c:if test="${kw == null  && reviewstate_map == null  &&  curriculum_id_map == null  && student_group_id_map == null }">
                                                ...
                                                <div class="well">
                                                        ...
                                                        <div class="col-xs-6 col-sm-4 col-md-4 col-lg-3">
                                                            <div class="form-group">
                                                                <input style="width: 100%;" type="text"
                                                                       class="form-control" id="kw" name="kw"
                                                                       value="${kw}"
                                                                       placeholder="模糊查询">
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <c:forEach var="item" items="${reviewstatelist}" varStatus="i">
                                                            <div class="col-xs-4 col-sm-3 col-md-3 col-lg-3">
                                                                <div class="checkbox3 checkbox-round checkbox-check checkbox-light">
                                                                    ...
                                                                    <label for="reviewstate_id${i.count}"> ${item.name} </label>
                                                                </div>
                                                            </div>
                                            ...
                                            <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                                ...
                                                <tbody>
                                                    <c:forEach var="it" items="${list}" varStatus="index">
                                                        <tr>
                                                            <td id="t${it.id}">
                                                                    ${index.count+(pager.current - 1) * pager.size}
                                                            </td>
                                                            <td>
                                                                    ${it.subject_name}
                                                                    <br>
                                                                    ${it.student_group_name}
                                                                    <br>
                                                                    ${it.student_group_code}
                                                            </td>
                                                            <td>
                                                                    ${it.truename}
                                                                    <br>
                                                            ...
                                                            <td>
                                                                ...
                                                                <c:if test="${it.submit !=0}">
                                                                    <fmt:formatDate pattern="yyyy-MM-dd" value="${it.submit_date}"/>
                                                                </c:if>
                                                            </td>
                                                            <td>${it.score}</td>
                                                            <td>
                                                            ...
                                                            <td>
                                                                <a href="${basePath}${pagename}?operate=edit&id=${it.id}" class="btn btn-sm btn-success">评阅</a>
                                                            </td>
                                                        </tr>
                                                    </c:forEach>
                                                </tbody>
                                ...
                                <c:forEach var="it" items="${list}" varStatus="index">
                                    <div class="col-xs-12 col-sm-6">
                                        <div class="row showbd margin-xs">
                                            <div class="col-xs-12 col-sm-12 bg-primary padding-xs" id="t${it.id}">
                                            ...
                                            <div class="col-xs-12 col-sm-12">
                                                <c:if test="${it.update_gmt !=0}">
                                                    <fmt:formatDate pattern="yyyy-MM-dd" value="${it.update_gmt_date}"/>
                                                </c:if>
                                            </div>
                                            <div class="clearfix"></div>
                                            ...
                                            <div class="col-xs-12 col-sm-12">
                                                <c:if test="${it.closing_gmt !=0}">
                                                    <fmt:formatDate pattern="yyyy-MM-dd" value="${it.closing_gmt_date}"/>
                                                </c:if>
                                            </div>
                                            <div class="clearfix"></div>
                                            ...
                                            <div class="col-xs-12 col-sm-12">
                                                <c:if test="${it.opening_gmt !=0}">
                                                    <fmt:formatDate pattern="yyyy-MM-dd" value="${it.opening_gmt_date}"/>
                                                </c:if>
                                            </div>
                                            <div class="clearfix"></div>
                                            ...
                                            <div class="col-xs-12 col-sm-12">
                                                <a href="${basePath}${pagename}?operate=moveup&id=${it.id}"
                                                   ...
                                                   <c:if test="${index.count==1}">disabled</c:if>>上移</a>
                                                <a href="${basePath}${pagename}?operate=movedown&id=${it.id}"
                                                ...
                                                <button value="${it.id}"
                                                        class="deleteitem btn btn-sm btn-danger">删除
                                                </button>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <P>${it.experiment_purposes_requirement}</P>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label">二、实验内容：</label>
                                        <div class="col-sm-10">
                                                <P>${it.experiment_content}</p>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <c:choose>
                                                ...
                                                <c:when test="${fn:length(filelist)>0}">
                                                    系统文件上传要求：单个文件大小不能超过10M，如果总量超出10M，压缩时分卷，多次上传。
                                                    <br/>
                                                    <%--   ${exp.filesize-filesize} exp是什么？    --%>
                                                    上传了${fn:length(filelist)}个文件，大约占用了${filesize}字节存储空间，还可以上传${exp.filesize-filesize}字节（
                                                    <fmt:formatNumber value="${(exp.filesize-filesize)/1024/1024}" type="number" groupingUsed="false" maxFractionDigits="2"/>MB）的内容。
                                                    <br/>
                                                    文件列表如下：
                                                    <br/>
                                                    <ul>
                                                        <c:forEach var="item" items="${filelist}" varStatus="xh">
                                                            <li class="am-margin-vertical">
                                                                <span class="am-text-danger">
                                                                    第${xh.count}个文件：${item.filename};&nbsp;&nbsp;&nbsp;&nbsp;文件大小：${item.filesize}字节
                                                                </span>
                                                                &nbsp;&nbsp;&nbsp;&nbsp;
                                                                <a href="teacher/experimentrecord/download?filehash=${item.filehash}&s=${it.subject_id}&e=${it.experiment_id}&u=${it.sno}"
                                                                        class="am-btn am-btn-default am-round am-btn-sm">
                                                                    下载
                                                                </a>
                                                            </li>
                                                        </c:forEach>
                                ...
                                <form id="form1" class="form-horizontal" method="post" action="${pagename}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4">
                                            <input type="number" class="form-control" id="score" min="0" max="100" style="color: red; font-size: 24px;" name="score"
                                            <c:choose>
                                                <c:when test="${it.scorescript =='已评'}">
                                                       value="${it.score}"
                                                </c:when>
...
<c:if test="${operate == null}">
    <script type="text/javascript">
        ...
        $("#searchbtn").click(function () {
            ...
            var and = "?";
            var reviewstate_id = "";
            $('input:checkbox[class=reviewstate_id_ck]:checked').each(
                function (k) {
                    if (k == 0) {
                        reviewstate_id = $(this).val();
                    } else {
                        reviewstate_id += ',' + $(this).val();
                    }
                });
            ...
            if (reviewstate_id != '') {
                qs += and + "reviewstate_id=" + reviewstate_id;
                and = "&";
            }
            var curriculum_id = "";
            $('input:checkbox[class=curriculum_id_ck]:checked').each(
                    function (k) {
                        if (k == 0) {
            ...
            $('input:checkbox[class=student_group_id_ck]:checked').each(
                    function (k) {
                        if (k == 0) {
