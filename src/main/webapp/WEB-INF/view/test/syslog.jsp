...
<!-- radio end -->
<div class="form-group">
	<label for="user_info" class="col-sm-3 control-label">用户标识</label>
	<div class="col-sm-9">
		<input type="text" class="form-control" id="user_info"
			name="user_info" placeholder="用户标识">
	</div>
</div>
<div class="form-group">
	<label for="user_ip" class="col-sm-3 control-label">用户IP</label>
	<div class="col-sm-9">
		<input type="text" class="form-control" id="user_ip"
			name="user_ip" placeholder="用户IP">
	</div>
</div>
<div class="form-group">
	<label for="spend_time" class="col-sm-3 control-label">耗时</label>
	<div class="col-sm-9">
...
<div class="form-group">
	<label for="request_content" class="col-sm-3 control-label">请求内容</label>
	<div class="col-sm-9">
		<input type="text" class="form-control" id="request_content"
			name="request_content" placeholder="请求内容">
	</div>
</div>
<div class="form-group">
	<label for="url" class="col-sm-3 control-label">请求路径</label>
	<div class="col-sm-9">
...
<div class="form-group">
	<label for="is_attack" class="col-sm-3 control-label">是否被判定为攻击</label>
	<div class="col-sm-9">
		<div
...
<div class="form-group">
	...
	<div class="col-sm-9">
		<input type="text" class="form-control" id="user_info"
			name="user_info" placeholder="用户标识" value="${it.user_info}">
	</div>
</div>
<div class="form-group">
	<label for="user_ip" class="col-sm-3 control-label">用户IP</label>
	<div class="col-sm-9">
		<input type="text" class="form-control" id="user_ip"
			name="user_ip" placeholder="用户IP" value="${it.user_ip}">
	</div>
</div>
<div class="form-group">
	<label for="spend_time" class="col-sm-3 control-label">耗时</label>
...
<div class="form-group">
	...
	<div class="col-sm-9">
		<input type="text" class="form-control" id="request_content"
			name="request_content" placeholder="请求内容" value="${it.request_content}">
	</div>
</div>
<div class="form-group">
	<label for="url" class="col-sm-3 control-label">请求路径</label>
