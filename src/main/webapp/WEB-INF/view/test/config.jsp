...
<div class="row">
	<c:forEach var="it" items="${list}" varStatus="index">
		<div class="col-xs-12 col-sm-6">
			...
			<div class="col-xs-12 col-sm-12">${it.value}</div>
				<div class="clearfix"></div>
...
<div class="form-group">
	<label for="name" class="col-sm-3 control-label">系统设置名称</label>
	<div class="col-sm-9">
		<input type="text" class="form-control" id="name"
			name="name" placeholder="系统设置名称">
	</div>
</div>
<div class="form-group">
	<label for="value" class="col-sm-3 control-label">系统配置值</label>
	<div class="col-sm-9">
		<input type="text" class="form-control" id="value"
			name="value" placeholder="系统配置值">
	</div>
</div>
<div class="form-group">
	<label for="remark" class="col-sm-3 control-label">系统配置备注</label>
	<div class="col-sm-9">
		<input type="text" class="form-control" id="remark"
			name="remark" placeholder="系统配置备注">
	</div>
</div>
<div class="form-group">
...
<div class="form-group">
	...
	<div class="col-sm-9">
		<input type="text" class="form-control" id="name"
			name="name" placeholder="系统设置名称" value="${it.name}">
	</div>
</div>
<div class="form-group">
	<label for="value" class="col-sm-3 control-label">系统配置值</label>
	<div class="col-sm-9">
		<input type="text" class="form-control" id="value"
			name="value" placeholder="系统配置值" value="${it.value}">
	</div>
</div>
<div class="form-group">
	<label for="remark" class="col-sm-3 control-label">系统配置备注</label>
	<div class="col-sm-9">
		<input type="text" class="form-control" id="remark"
			name="remark" placeholder="系统配置备注" value="${it.remark}">
	</div>
</div>
<div class="form-group">
	<label for="create_userid" class="col-sm-3 control-label">创建者</label>
