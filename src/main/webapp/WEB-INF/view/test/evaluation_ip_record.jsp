...
<!-- radio end -->
<div class="form-group">
	<label for="sno" class="col-sm-3 control-label"></label>
	<div class="col-sm-9">
		<input type="text" class="form-control" id="sno"
			name="sno" placeholder="">
	</div>
</div>
<!-- selectbox begin -->
<div class="form-group">
	<label for="evaluation_id" class="col-sm-3 control-label"></label>
	<div class="col-sm-9">
...
<!-- radio end -->
<div class="form-group">
	<label for="ip" class="col-sm-3 control-label"></label>
	<div class="col-sm-9">
...
<div class="form-group d_t_dater">
	<label for="create_gmt_date" class="col-sm-3 control-label"></label>
	<div class="col-sm-9">
		<div class="input-group">
	<span class="input-group-addon" style="cursor: pointer;"
	onclick="$.jeDate('#create_gmt_date',{trigger:false,format: 'YYYY-MM-DD hh:mm:ss'})"></span>
...
<div class="form-group">
	...
	<div class="col-sm-9">
		<input type="text" class="form-control" id="sno"
			name="sno" placeholder="" value="${it.sno}">
	</div>
</div>
<!-- selectbox begin -->
<div class="form-group">
...
<div class="form-group">
	...
	<div class="col-sm-9">
		<input type="text" class="form-control" id="ip"
			name="ip" placeholder="" value="${it.ip}">
	</div>
</div>
<div class="form-group d_t_dater">
	<label for="create_gmt_date" class="col-sm-3 control-label"></label>
...
<div class="form-group">
	...
	<div class="col-sm-9">
		<input type="text" class="form-control restrictnumber" id="type"
			name="type" placeholder="" value="${it.type}">
	</div>
</div>
<div class="form-group">
	<div class="col-sm-offset-3 col-sm-9">
