...
<c:if test="${searchpanel=='true'}">
	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
		<div class="row">
			<div class="col-sm-12">
				<div id="searchPanel"
					<c:if test="${kw != null  || student_id_map != null  || evaluation_id_map != null  || evaluation_point_id_map != null  || subject_id_map != null  || student_group_id_map != null  || curriculum_id_map != null }">class="collapse in form-inline" </c:if>
					<c:if test="${kw == null  && student_id_map == null  && evaluation_id_map == null  && evaluation_point_id_map == null  && subject_id_map == null  && student_group_id_map == null  && curriculum_id_map == null }">class="collapse form-inline" </c:if>>
					<div class="well">
						<!-- 面板 -->
						<div class="row">
							<div
...
<!-- radio end -->
						...
						<div class="row">
							<div class="col-xs-4 col-sm-3 col-md-2 col-lg-2 text-right margin-top-xs">
								考核:</div>
							<c:forEach var="item" items="${evaluationlist}" varStatus="i">
<!-- checkbox begin -->
								<div class="col-xs-4 col-sm-3 col-md-3 col-lg-3">
									<div class="checkbox3 checkbox-${tagpostfixlist[i.count%fn:length(tagpostfixlist)]} checkbox-check checkbox-light">
										<input value="${item.id}" id="evaluation_id${i.count}"
class="evaluation_id_ck" type="checkbox"
<c:if test="${evaluation_id_map.get(item.id) != null}">checked</c:if>>
										<label for="evaluation_id${i.count}"> ${item.name} </label>
									</div>
								</div>
<!-- checkbox end -->
<!-- radio begin -->
			<div class="radio3 radio-check radio-${tagpostfixlist[i.count%fn:length(tagpostfixlist)]} radio-inline">
				<input type="radio" id="evaluation_id${i.count}" name="evaluation_id" value="${item.id}" <c:if test="${evaluation_id_map.get(item.id) != null}">checked</c:if>> <label for="evaluation_id${i.count}">${item.name}</label>
			</div>
<!-- radio end -->
								<div class="visible-lg-block">
									<c:if test="${i.count % 3==0}">
						...
						<div class="row">
							<div class="col-xs-4 col-sm-3 col-md-2 col-lg-2 text-right margin-top-xs">
								对应考核点:</div>
							<c:forEach var="item" items="${evaluation_pointlist}" varStatus="i">
<!-- checkbox begin -->
								<div class="col-xs-4 col-sm-3 col-md-3 col-lg-3">
									<div class="checkbox3 checkbox-${tagpostfixlist[i.count%fn:length(tagpostfixlist)]} checkbox-check checkbox-light">
										<input value="${item.id}" id="evaluation_point_id${i.count}"
class="evaluation_point_id_ck" type="checkbox"
<c:if test="${evaluation_point_id_map.get(item.id) != null}">checked</c:if>>
										<label for="evaluation_point_id${i.count}"> ${item.name} </label>
									</div>
								</div>
<!-- checkbox end -->
<!-- radio begin -->
			<div class="radio3 radio-check radio-${tagpostfixlist[i.count%fn:length(tagpostfixlist)]} radio-inline">
				<input type="radio" id="evaluation_point_id${i.count}" name="evaluation_point_id" value="${item.id}" <c:if test="${evaluation_point_id_map.get(item.id) != null}">checked</c:if>> <label for="evaluation_point_id${i.count}">${item.name}</label>
			</div>
<!-- radio end -->
								<div class="visible-lg-block">
									<c:if test="${i.count % 3==0}">
												...
												<tbody>
													<c:forEach var="it" items="${list}" varStatus="index">
														<tr>
															...
															<td>${evaluationmap[it.evaluation_id]}</td>
															<td>${it.sno}</td>
															<td>${evaluation_pointmap[it.evaluation_point_id]}</td>
															<td>${it.submit_record}</td>
															<td>${it.score}</td>
															<td>${it.type}</td>
	...
	<c:choose>
		...
		<c:when test="${it.is_submited==false}">
			<a href="${basePath}${pagename}?operate=showitem&id=${it.id}" ><img alt="" src="bssets/i/reddot.png"></a>
															...
															<td>
	<c:choose>
		<c:when test="${it.is_reviewed}">
			<a href="${basePath}${pagename}?operate=hideitem&id=${it.id}" ><img alt="" src="bssets/i/greendot.png"></a>
		</c:when>
		<c:when test="${it.is_reviewed==false}">
			<a href="${basePath}${pagename}?operate=showitem&id=${it.id}" ><img alt="" src="bssets/i/reddot.png"></a>
		</c:when>
	</c:choose>
</td>
...
<div class="row">
	<c:forEach var="it" items="${list}" varStatus="index">
		<div class="col-xs-12 col-sm-6">
			...
			<div class="col-xs-12 col-sm-12">${it.evaluation_id}</div>
				<div class="clearfix"></div>

			<div class="col-xs-12 col-sm-12">${it.sno}</div>
				<div class="clearfix"></div>

			<div class="col-xs-12 col-sm-12">${it.evaluation_point_id}</div>
				<div class="clearfix"></div>

			<div class="col-xs-12 col-sm-12">${it.submit_record}</div>
				<div class="clearfix"></div>
			...
			<div class="col-xs-12 col-sm-12">${it.is_submited}</div>
				<div class="clearfix"></div>

			<div class="col-xs-12 col-sm-12">${it.score_wish}</div>
				<div class="clearfix"></div>

			<div class="col-xs-12 col-sm-12">${it.is_reviewed}</div>
				<div class="clearfix"></div>
...
<!-- selectbox begin -->
<div class="form-group">
	<label for="evaluation_id" class="col-sm-3 control-label">考核id</label>
	<div class="col-sm-9">
		<select class="selectbox" id="evaluation_id" name="evaluation_id"  style="width:100%;">
			<c:forEach var="item" items="${evaluationlist}" varStatus="i">
				<option value="${item.id}" >${item.name}</option>
			</c:forEach>
		</select>
...
<!-- radio begin -->
			<c:forEach var="item" items="${evaluationlist}" varStatus="i">
			<div class="radio3 radio-check radio-${tagpostfixlist[i.count%fn:length(tagpostfixlist)]} radio-inline">
				<input type="radio" id="evaluation_id${i.count}" name="evaluation_id" value="${item.id}" <c:if test="${i.count==1}">checked</c:if>> <label for="evaluation_id${i.count}">${item.name}</label>
			</div>
			</c:forEach>
<!-- radio end -->
<div class="form-group">
	<label for="sno" class="col-sm-3 control-label">考号，学号</label>
	<div class="col-sm-9">
		<input type="text" class="form-control" id="sno"
			name="sno" placeholder="考号，学号">
	</div>
</div>
<!-- selectbox begin -->
<div class="form-group">
	<label for="evaluation_point_id" class="col-sm-3 control-label">对应考核点</label>
	<div class="col-sm-9">
		<select class="selectbox" id="evaluation_point_id" name="evaluation_point_id"  style="width:100%;">
			<c:forEach var="item" items="${evaluation_pointlist}" varStatus="i">
				<option value="${item.id}" >${item.name}</option>
			</c:forEach>
		</select>
...
<!-- radio begin -->
			<c:forEach var="item" items="${evaluation_pointlist}" varStatus="i">
			<div class="radio3 radio-check radio-${tagpostfixlist[i.count%fn:length(tagpostfixlist)]} radio-inline">
				<input type="radio" id="evaluation_point_id${i.count}" name="evaluation_point_id" value="${item.id}" <c:if test="${i.count==1}">checked</c:if>> <label for="evaluation_point_id${i.count}">${item.name}</label>
			</div>
			</c:forEach>
<!-- radio end -->
<div class="form-group">
	<label for="submit_record" class="col-sm-3 control-label">记录考生提交内容</label>
	<div class="col-sm-9">
<textarea class="form-control" id="submit_record" name="submit_record" style="width:100%;height:400px;visibility:hidden;"></textarea>
	</div>
</div>
<div class="form-group">
...
<div class="form-group">
	<label for="type" class="col-sm-3 control-label">考核点类型id</label>
	<div class="col-sm-9">
		<input type="text" class="form-control restrictnumber" id="type"
			name="type" placeholder="考核点类型id" >
	</div>
</div>
<!-- selectbox begin -->
<div class="form-group">
	<label for="subject_id" class="col-sm-3 control-label">科目id</label>
	<div class="col-sm-9">
...
<!-- selectbox begin -->
<div class="form-group">
	<label for="student_group_id" class="col-sm-3 control-label">班号</label>
	<div class="col-sm-9">
...
<div class="form-group">
	<label for="is_submited" class="col-sm-3 control-label">是否已经提交</label>
	<div class="col-sm-9">
		<div
			class="checkbox3 checkbox-round checkbox-check checkbox-light">
					<input type="checkbox" id="is_submited" name="is_submited">
			<label for="is_submited"> 是否已经提交 </label>
		</div>
	</div>
</div>
<div class="form-group">
	<label for="score_wish" class="col-sm-3 control-label">满分</label>
	<div class="col-sm-9">
		<input type="text" class="form-control restrictnumber" id="score_wish"
			name="score_wish" placeholder="满分" >
	</div>
</div>
<div class="form-group">
	<label for="is_reviewed" class="col-sm-3 control-label">是否已评阅1已评,2待评</label>
	<div class="col-sm-9">
		<div
			class="checkbox3 checkbox-round checkbox-check checkbox-light">
					<input type="checkbox" id="is_reviewed" name="is_reviewed">
			<label for="is_reviewed"> 是否已评阅1已评,2待评 </label>
		</div>
	</div>
</div>
...
<div class="form-group">
	...
	<div class="col-sm-9">
		<select class="selectbox" id="evaluation_id" name="evaluation_id"  style="width:100%;">
			<c:forEach var="item" items="${evaluationlist}" varStatus="i">
				<option value="${item.id}"
					<c:if test="${item.id==it.evaluation_id}">selected</c:if>>${item.name}</option>
			</c:forEach>
		</select>
	</div>
</div>
...
<!-- radio begin -->
			<c:forEach var="item" items="${evaluationlist}" varStatus="i">
			<div class="radio3 radio-check radio-${tagpostfixlist[i.count%fn:length(tagpostfixlist)]} radio-inline">
				<input type="radio" id="evaluation_id${i.count}" name="evaluation_id" value="${item.id}" <c:if test="${item.id==it.evaluation_id}">checked</c:if>> <label for="evaluation_id${i.count}">${item.name}</label>
			</div>
			</c:forEach>
<!-- radio end -->
<div class="form-group">
	...
	<div class="col-sm-9">
		<input type="text" class="form-control" id="sno"
			name="sno" placeholder="考号，学号" value="${it.sno}">
	</div>
</div>
<!-- selectbox begin -->
<div class="form-group">
	...
	<div class="col-sm-9">
		<select class="selectbox" id="evaluation_point_id" name="evaluation_point_id"  style="width:100%;">
			<c:forEach var="item" items="${evaluation_pointlist}" varStatus="i">
				<option value="${item.id}"
					<c:if test="${item.id==it.evaluation_point_id}">selected</c:if>>${item.name}</option>
			</c:forEach>
		</select>
	</div>
</div>
...
<!-- radio begin -->
			<c:forEach var="item" items="${evaluation_pointlist}" varStatus="i">
			<div class="radio3 radio-check radio-${tagpostfixlist[i.count%fn:length(tagpostfixlist)]} radio-inline">
				<input type="radio" id="evaluation_point_id${i.count}" name="evaluation_point_id" value="${item.id}" <c:if test="${item.id==it.evaluation_point_id}">checked</c:if>> <label for="evaluation_point_id${i.count}">${item.name}</label>
			</div>
			</c:forEach>
<!-- radio end -->
<div class="form-group">
	<label for="submit_record" class="col-sm-3 control-label">记录考生提交内容</label>
	<div class="col-sm-9">
<textarea class="form-control" id="submit_record" name="submit_record" style="width:100%;height:400px;visibility:hidden;">${it.submit_record}</textarea>
	</div>
</div>
<div class="form-group">
	<label for="score" class="col-sm-3 control-label">成绩</label>
	<div class="col-sm-9">
		<input type="text" class="form-control restrictnumber" id="score"
			name="score" placeholder="成绩" value="${it.score}">
	</div>
</div>
<div class="form-group">
	<label for="type" class="col-sm-3 control-label">考核点类型id</label>
	<div class="col-sm-9">
		<input type="text" class="form-control restrictnumber" id="type"
			name="type" placeholder="考核点类型id" value="${it.type}">
	</div>
</div>
<!-- selectbox begin -->
<div class="form-group">
...
<div class="form-group">
	...
	<div class="col-sm-9">
		<div
			class="checkbox3 checkbox-round checkbox-check checkbox-light">
			<c:choose>
				<c:when test="${it.is_submited == true}">
					<input type="checkbox" id="is_submited" name="is_submited"
						checked>
				</c:when>
				<c:when test="${it.is_submited == false}">
...
<div class="form-group">
	...
	<div class="col-sm-9">
		<input type="text" class="form-control restrictnumber" id="score_wish"
			name="score_wish" placeholder="满分" value="${it.score_wish}">
	</div>
</div>
<div class="form-group">
	<label for="is_reviewed" class="col-sm-3 control-label">是否已评阅1已评,2待评</label>
	<div class="col-sm-9">
		<div
			class="checkbox3 checkbox-round checkbox-check checkbox-light">
			<c:choose>
				<c:when test="${it.is_reviewed == true}">
					<input type="checkbox" id="is_reviewed" name="is_reviewed"
						checked>
				</c:when>
				<c:when test="${it.is_reviewed == false}">
		...
		<script type="text/javascript">
			$(document).ready(function() {
				...
				$("#form1").submit(function(e) {
					...
					if ($("#evaluation_point_id").val() == '') {
						alert("对应考核点必须输入！");
						$("#evaluation_point_id").focus();
						return false;
					}
					if ($("#submit_record").val() == '') {
						alert("记录考生提交内容必须输入！");
						$("#submit_record").focus();
						return false;
					}
...
KindEditor.ready(function(K) {
	var editor1 = K.create('textarea[name="submit_record"]', {
...
$("#searchbtn").click(function() {
	...
	var evaluation_id = "";
	$('input:checkbox[class=evaluation_id_ck]:checked').each(function(k) {
		if (k == 0) {
			evaluation_id = $(this).val();
		} else {
			evaluation_id += ',' + $(this).val();
		}
	});
	...
	if (evaluation_id != '') {
		qs += and + "evaluation_id=" + evaluation_id;
		and = "&";
	}
	var evaluation_point_id = "";
	$('input:checkbox[class=evaluation_point_id_ck]:checked').each(function(k) {
		if (k == 0) {
			evaluation_point_id = $(this).val();
		} else {
			evaluation_point_id += ',' + $(this).val();
		}
	});
	// alert('evaluation_point_id=' + evaluation_point_id);
	if (evaluation_point_id != '') {
		qs += and + "evaluation_point_id=" + evaluation_point_id;
		and = "&";
	}
	var subject_id = "";
