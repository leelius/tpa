/**
 * 
 * 2018年4月25日，必须包含两个css文件 skins/default/laydate.css need/laydate.css 位置改天再来移动，
 * skin			line21 ../指定datepicker3.css位置在js上一层目录   line11 css
 * core_style	line509  
 * 
 */
...
;!
    function(a) {
        var b = {
            ...
            h = ["laydate_box", "laydate_void", "laydate_click", "LayDateSkin", "../css/datepicker3/skin", "/datepicker3.css"];//skin
        a.laydate = function(b) {
            ...
            c.init = function() {
                c.use("../css/datepicker3/corestyle"),//core_style
