...
@NoArgsConstructor
@TableName("`vexperiment_record_mini`")
public class Vexperiment_record_mini extends SuperEntity {
    ...
    public Vexperiment_record_mini (Integer id, Integer student_id, Integer experiment_id, Integer curriculum_id, String truename, String sno, String sno_exp, String classcode, Integer score, Boolean student_group_is_actived, Boolean student_is_actived, Boolean curriculum_is_actived, Boolean experiment_curriculum_is_actived, Boolean subject_is_actived, String student_group_code, String student_group_name, Long submit, String scorescript, String wechat_openid, String experiment_title, Boolean experiment_is_actived, String subject_name, Integer subject_id, Integer user_id, Long closing_gmt, Long opening_gmt, Integer curriculum_student_groupid, Integer student_group_id, Integer reviewstate, Integer experiment_curriculumid) {
        this.id = id;
    ...
    public Vexperiment_record_mini (Integer student_id,Integer experiment_id,Integer curriculum_id,String truename,String sno,String sno_exp,String classcode,Integer score,Boolean student_group_is_actived,Boolean student_is_actived,Boolean curriculum_is_actived,Boolean experiment_curriculum_is_actived,Boolean subject_is_actived,String student_group_code,String student_group_name,Long submit,String scorescript,String wechat_openid,String experiment_title,Boolean experiment_is_actived,String subject_name,Integer subject_id,Integer user_id,Long closing_gmt,Long opening_gmt,Integer curriculum_student_groupid,Integer student_group_id,Integer reviewstate,Integer experiment_curriculumid) {
        this.student_id = student_id;
        this.experiment_id = experiment_id;
        this.curriculum_id = curriculum_id;
        this.truename = truename;
