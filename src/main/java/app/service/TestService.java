...
public class TestService {
	 ...
	 * @return
	 */
	public PagerList<Config> pagerListConfig(Integer pagenumber, Integer pagesize, String keyword, Map<String, String> sqlin) {
	 ...
	 * @return
	 */
	public PagerList<Config> pagerListConfig(Integer pagenumber, Integer pagesize, String keyword, Map<String, String> sqlin, Map<String, Object> params) {
		List<KeyAndValue> ordlist=new ArrayList<KeyAndValue>();
		ordlist.add(new KeyAndValue(Config.ID,  "desc"));
	 ...
	 * @return
	 */
	public PagerList<Config> pagerListConfig(Integer pagenumber, Integer pagesize, String keyword, Map<String, String> sqlin, Map<String, Object> params, List<KeyAndValue> ordlist) {
		...
		if (StringUtils.isBlank(keyword)) {
			...
			if (!StringUtils.isBlank(keyword)) {
				String kwss = keyword;
				queryWrapper.and(wr->wr.like(Config.NAME, kwss)
					.or().like(Config.VALUE, kwss)
					.or().like(Config.REMARK, kwss)
						);
			}
			// 添加id使用in语句筛选
			// --------2.模糊匹配模式---------
	 ...
	 * @return 是否成功 
	 */
	public Boolean updateConfigById(String name,String value,String remark,Integer update_userid,Long update_gmt,Integer id) {
	...
	public Map<String, Integer> statConfigGroupbyId() {
		List<Map<String, Object>> list = svcconfig.listMaps(new QueryWrapper<Config>()
		.select(Config.NAME, "count(*)")
		.eq(Config.CREATE_USERID, 0)
		.groupBy(Config.ID)
		.orderByAsc(Config.ID)
		);
	...
	public Curriculum getCurriculumBySubject_id(Serializable subject_id) {
		...
		return svccurriculum.getOne(new QueryWrapper<Curriculum>().eq(Curriculum.SUBJECT_ID, subject_id).last("limit 1"));
	}
	 ...
	 * @return
	 */
	public PagerList<Curriculum> pagerListCurriculum(Integer pagenumber, Integer pagesize, String keyword, Map<String, String> sqlin) {
	 ...
	 * @return
	 */
	public PagerList<Curriculum> pagerListCurriculum(Integer pagenumber, Integer pagesize, String keyword, Map<String, String> sqlin, Map<String, Object> params) {
		List<KeyAndValue> ordlist=new ArrayList<KeyAndValue>();
		ordlist.add(new KeyAndValue(Curriculum.ID,  "desc"));
	 ...
	 * @return
	 */
	public PagerList<Curriculum> pagerListCurriculum(Integer pagenumber, Integer pagesize, String keyword, Map<String, String> sqlin, Map<String, Object> params, List<KeyAndValue> ordlist) {
		...
		if (StringUtils.isBlank(keyword) && StringUtils.isBlank(subject_id)  && StringUtils.isBlank(student_group_id)  && StringUtils.isBlank(user_id) ) {
		...
		for (int i = 0; i < list.size(); i++) {
			...
			if (!StringUtils.isBlank(keyword)) {
				...
				try {
					...
					list.get(i).setSemester((list.get(i).getSemester().replace(keyword, Common.getKeywordSpan(keyword))));
				} catch (Exception e) {
				    e.printStackTrace();
				}
			}
	 ...
	 * @return 是否成功 
	 */
	public Boolean updateCurriculumById(Integer subject_id,Integer student_group_id,Integer user_id,Boolean is_actived,String semester,Long update_gmt,Integer id) {
	...
	public Map<String, Integer> statCurriculumGroupbyId() {
		List<Map<String, Object>> list = svccurriculum.listMaps(new QueryWrapper<Curriculum>()
		.select(Curriculum.SEMESTER, "count(*)")
		.eq(Curriculum.SUBJECT_ID, 0)
		.groupBy(Curriculum.ID)
		.orderByAsc(Curriculum.ID)
		);
	...
	public Evaluation getEvaluationByCurriculum_id(Serializable curriculum_id) {
		...
		return svcevaluation.getOne(new QueryWrapper<Evaluation>().eq(Evaluation.CURRICULUM_ID, curriculum_id).last("limit 1"));
	}
	 ...
	 * @return
	 */
	public PagerList<Evaluation> pagerListEvaluation(Integer pagenumber, Integer pagesize, String keyword, Map<String, String> sqlin) {
	 ...
	 * @return
	 */
	public PagerList<Evaluation> pagerListEvaluation(Integer pagenumber, Integer pagesize, String keyword, Map<String, String> sqlin, Map<String, Object> params) {
		List<KeyAndValue> ordlist=new ArrayList<KeyAndValue>();
	 ...
	 * @return
	 */
	public PagerList<Evaluation> pagerListEvaluation(Integer pagenumber, Integer pagesize, String keyword, Map<String, String> sqlin, Map<String, Object> params, List<KeyAndValue> ordlist) {
		...
		if (StringUtils.isBlank(keyword) && StringUtils.isBlank(curriculum_id) ) {
			...
			if (!StringUtils.isBlank(keyword)) {
				String kwss = keyword;
				queryWrapper.and(wr->wr.like(Evaluation.CONTENT, kwss)
					.or().like(Evaluation.TITLE, kwss)
						);
			}
			// 添加id使用in语句筛选
	 ...
	 * @return 是否成功 
	 */
	public Boolean updateEvaluationById(Integer curriculum_id,Boolean is_actived,Long begin_gmt,Long end_gmt,String content,String title,Integer sortid,Long update_gmt,Integer id) {
	...
	public Map<String, Integer> statEvaluationGroupbyId() {
		List<Map<String, Object>> list = svcevaluation.listMaps(new QueryWrapper<Evaluation>()
		.select(Evaluation.CONTENT, "count(*)")
		.eq(Evaluation.CURRICULUM_ID, 0)
		.groupBy(Evaluation.ID)
		.orderByAsc(Evaluation.ID)
		);
	 ...
	 * @return Evaluation_ip_record列表 
	 */
	public List<Evaluation_ip_record> listEvaluation_ip_recordByMap(Map<String, Object> params, List<KeyAndValue> ordlist) {
	...
	public Evaluation_ip_record getEvaluation_ip_recordByStudent_id(Serializable student_id) {
		...
		return svcevaluation_ip_record.getOne(new QueryWrapper<Evaluation_ip_record>().eq(Evaluation_ip_record.STUDENT_ID, student_id).last("limit 1"));
	}
	...
	public List<Evaluation_ip_record> listEvaluation_ip_recordByMapAsc(Map<String, Object> params,String columnname) {
		...
		return svcevaluation_ip_record.list(new QueryWrapper<Evaluation_ip_record>().allEq(params).orderByAsc(columnname));
	}
	...
	public List<Evaluation_ip_record> listEvaluation_ip_recordByMapDesc(Map<String, Object> params,String columnname) {
		...
		return svcevaluation_ip_record.list(new QueryWrapper<Evaluation_ip_record>().allEq(params).orderByDesc(columnname));
	}
	 ...
	 * @return
	 */
	public PagerList<Evaluation_ip_record> pagerListEvaluation_ip_record(Integer pagenumber, Integer pagesize, String keyword) {
	 ...
	 * @return
	 */
	public PagerList<Evaluation_ip_record> pagerListEvaluation_ip_record(Integer pagenumber, Integer pagesize, String keyword, Map<String, String> sqlin) {
	 ...
	 * @return
	 */
	public PagerList<Evaluation_ip_record> pagerListEvaluation_ip_record(Integer pagenumber, Integer pagesize, String keyword, Map<String, String> sqlin, Map<String, Object> params) {
		List<KeyAndValue> ordlist=new ArrayList<KeyAndValue>();
		ordlist.add(new KeyAndValue(Evaluation_ip_record.ID,  "desc"));
	 ...
	 * @return
	 */
	public PagerList<Evaluation_ip_record> pagerListEvaluation_ip_record(Integer pagenumber, Integer pagesize, String keyword, Map<String, String> sqlin, Map<String, Object> params, List<KeyAndValue> ordlist) {
		...
		if (StringUtils.isBlank(keyword) && StringUtils.isBlank(student_id)  && StringUtils.isBlank(evaluation_id) ) {
			...
			if (!StringUtils.isBlank(keyword)) {
				String kwss = keyword;
				queryWrapper.and(wr->wr.like(Evaluation_ip_record.SNO, kwss)
					.or().like(Evaluation_ip_record.IP, kwss)
						);
			}
			// 添加id使用in语句筛选
	 ...
	 * @return 是否成功 
	 */
	public Boolean updateEvaluation_ip_recordById(Integer student_id,String sno,Integer evaluation_id,String ip,Integer type,Integer id) {
	...
	public Map<String, Integer> statEvaluation_ip_recordGroupbyId() {
		...
		.select(Evaluation_ip_record.SNO, "count(*)")
		.eq(Evaluation_ip_record.STUDENT_ID, 0)
		.groupBy(Evaluation_ip_record.ID)
		.orderByAsc(Evaluation_ip_record.ID)
		);
	...
	public Evaluation_point getEvaluation_pointBySubject_id(Serializable subject_id) {
		...
		return svcevaluation_point.getOne(new QueryWrapper<Evaluation_point>().eq(Evaluation_point.SUBJECT_ID, subject_id).last("limit 1"));
	}
	 ...
	 * @return
	 */
	public PagerList<Evaluation_point> pagerListEvaluation_point(Integer pagenumber, Integer pagesize, String keyword, Map<String, String> sqlin) {
	 ...
	 * @return
	 */
	public PagerList<Evaluation_point> pagerListEvaluation_point(Integer pagenumber, Integer pagesize, String keyword, Map<String, String> sqlin, Map<String, Object> params) {
		List<KeyAndValue> ordlist=new ArrayList<KeyAndValue>();
		ordlist.add(new KeyAndValue(Evaluation_point.ID,  "desc"));
	 ...
	 * @return
	 */
	public PagerList<Evaluation_point> pagerListEvaluation_point(Integer pagenumber, Integer pagesize, String keyword, Map<String, String> sqlin, Map<String, Object> params, List<KeyAndValue> ordlist) {
	 ...
	 * @return 是否成功 
	 */
	public Boolean updateEvaluation_pointById(Integer subject_id,Boolean is_actived,Integer type,Integer difficulty,String content,Long update_gmt,Integer id) {
	...
	public Map<String, Integer> statEvaluation_pointGroupbyId() {
		...
		.select(Evaluation_point.CONTENT, "count(*)")
		.eq(Evaluation_point.SUBJECT_ID, 0)
		.groupBy(Evaluation_point.ID)
		.orderByAsc(Evaluation_point.ID)
		);
	...
	public Evaluation_result getEvaluation_resultByStudent_id(Serializable student_id) {
		...
		return svcevaluation_result.getOne(new QueryWrapper<Evaluation_result>().eq(Evaluation_result.STUDENT_ID, student_id).last("limit 1"));
	}
	 ...
	 * @return
	 */
	public PagerList<Evaluation_result> pagerListEvaluation_result(Integer pagenumber, Integer pagesize, String keyword, Map<String, String> sqlin) {
	 ...
	 * @return
	 */
	public PagerList<Evaluation_result> pagerListEvaluation_result(Integer pagenumber, Integer pagesize, String keyword, Map<String, String> sqlin, Map<String, Object> params) {
		List<KeyAndValue> ordlist=new ArrayList<KeyAndValue>();
		ordlist.add(new KeyAndValue(Evaluation_result.ID,  "desc"));
	 ...
	 * @return
	 */
	public PagerList<Evaluation_result> pagerListEvaluation_result(Integer pagenumber, Integer pagesize, String keyword, Map<String, String> sqlin, Map<String, Object> params, List<KeyAndValue> ordlist) {
		...
		if (StringUtils.isBlank(keyword) && StringUtils.isBlank(student_id)  && StringUtils.isBlank(evaluation_id) ) {
			...
			if (!StringUtils.isBlank(keyword)) {
				String kwss = keyword;
				queryWrapper.and(wr->wr.like(Evaluation_result.SNO, kwss)
					.or().like(Evaluation_result.COMMENT, kwss)
		...
		for (int i = 0; i < list.size(); i++) {
			...
			if (!StringUtils.isBlank(keyword)) {
				...
				try {
					...
					list.get(i).setEvaluation_record((list.get(i).getEvaluation_record().replace(keyword, Common.getKeywordSpan(keyword))));
				} catch (Exception e) {
				    e.printStackTrace();
				}
			}
	 ...
	 * @return 是否成功 
	 */
	public Boolean updateEvaluation_resultById(Integer student_id,Integer evaluation_id,String sno,String comment,String evaluation_record,Integer score,Long submit_gmt,Boolean is_reviewed,Long update_gmt,Integer id) {
	...
	public Map<String, Integer> statEvaluation_resultGroupbyId() {
		...
		.select(Evaluation_result.SNO, "count(*)")
		.eq(Evaluation_result.STUDENT_ID, 0)
		.groupBy(Evaluation_result.ID)
		.orderByAsc(Evaluation_result.ID)
		);
	 ...
	 * @return Evaluation_result_record列表 
	 */
	public List<Evaluation_result_record> listEvaluation_result_recordByMap(Map<String, Object> params, List<KeyAndValue> ordlist) {
	...
	public Evaluation_result_record getEvaluation_result_recordByStudent_id(Serializable student_id) {
		...
		return svcevaluation_result_record.getOne(new QueryWrapper<Evaluation_result_record>().eq(Evaluation_result_record.STUDENT_ID, student_id).last("limit 1"));
	}
	...
	public Evaluation_result_record getEvaluation_result_recordByMap(Map<String, Object> params) {
		...
		//Map<String, Object> params = new HashMap<String, Object>();
		//params.put(Evaluation_result_record.ID, 0);
		return svcevaluation_result_record.getOne(new QueryWrapper<Evaluation_result_record>().allEq(params).last("limit 1"));
	}
	 ...
	 * @return Evaluation_result_record列表 
	 */
	public List<Evaluation_result_record> listEvaluation_result_recordByMapAsc(Map<String, Object> params,String columnname) {

		logger.debug(this.getClass().getName() + ".listEvaluation_result_recordByMapAsc()");
		return svcevaluation_result_record.list(new QueryWrapper<Evaluation_result_record>().allEq(params).orderByAsc(columnname));
	}
	 ...
	 * @return Evaluation_result_record列表 
	 */
	public List<Evaluation_result_record> listEvaluation_result_recordByMapDesc(Map<String, Object> params,String columnname) {

		logger.debug(this.getClass().getName() + ".listEvaluation_result_recordByMapDesc()");
		return svcevaluation_result_record.list(new QueryWrapper<Evaluation_result_record>().allEq(params).orderByDesc(columnname));
	}
	 ...
	 * @return
	 */
	public PagerList<Evaluation_result_record> pagerListEvaluation_result_record(Integer pagenumber, Integer pagesize, String keyword) {
	 ...
	 * @return
	 */
	public PagerList<Evaluation_result_record> pagerListEvaluation_result_record(Integer pagenumber, Integer pagesize, String keyword, Map<String, String> sqlin) {
	 ...
	 * @return
	 */
	public PagerList<Evaluation_result_record> pagerListEvaluation_result_record(Integer pagenumber, Integer pagesize, String keyword, Map<String, String> sqlin, Map<String, Object> params) {
		List<KeyAndValue> ordlist=new ArrayList<KeyAndValue>();
	 ...
	 * @return
	 */
	public PagerList<Evaluation_result_record> pagerListEvaluation_result_record(Integer pagenumber, Integer pagesize, String keyword, Map<String, String> sqlin, Map<String, Object> params, List<KeyAndValue> ordlist) {
		...
		if (StringUtils.isBlank(keyword) && StringUtils.isBlank(student_id)  && StringUtils.isBlank(evaluation_id)  && StringUtils.isBlank(evaluation_point_id)  && StringUtils.isBlank(subject_id)  && StringUtils.isBlank(student_group_id)  && StringUtils.isBlank(curriculum_id) ) {
			...
			if (!StringUtils.isBlank(keyword)) {
				String kwss = keyword;
				queryWrapper.and(wr->wr.like(Evaluation_result_record.SNO, kwss)
					.or().like(Evaluation_result_record.SUBMIT_RECORD, kwss)
						);
			}
			// 添加id使用in语句筛选
			if (!StringUtils.isBlank(student_id)) {
		...
		for (int i = 0; i < list.size(); i++) {
			...
			if (!StringUtils.isBlank(keyword)) {
				...
				try {
					...
					list.get(i).setSno((list.get(i).getSno().replace(keyword, Common.getKeywordSpan(keyword))));
					list.get(i).setSubmit_record((list.get(i).getSubmit_record().replace(keyword, Common.getKeywordSpan(keyword))));
				} catch (Exception e) {
				    e.printStackTrace();
				}
			}
	 ...
	 * @return 是否成功 
	 */
	public Boolean updateEvaluation_result_recordById(Integer student_id,Integer evaluation_id,String sno,Integer evaluation_point_id,String submit_record,Integer score,Integer type,Integer subject_id,Integer student_group_id,Integer curriculum_id,Integer difficulty,Integer sortid,Boolean is_submited,Integer score_wish,Boolean is_reviewed,Long update_gmt,Integer id) {
	...
	public Boolean moveEvaluation_result_record(String method, String upOrDown, Integer id, String sortColumn) {
		...
		QueryWrapper<Evaluation_result_record> queryWrapper = new QueryWrapper<>();
		// 同一个父栏目下
		// queryWrapper.eq(Evaluation_result_record.COLUMN_PARENTID , it.getColumn_parentid());
		if (method.equals(upOrDown)) {
			queryWrapper.lt(sortColumn, it.getSortid());
			queryWrapper.orderByDesc(sortColumn);
		} else {
	...
	public Map<String, Integer> statEvaluation_result_recordGroupbyId() {
		List<Map<String, Object>> list = svcevaluation_result_record.listMaps(new QueryWrapper<Evaluation_result_record>()
		.select(Evaluation_result_record.SNO, "count(*)")
		.eq(Evaluation_result_record.STUDENT_ID, 0)
		.groupBy(Evaluation_result_record.ID)
	...
	public Evaluation_type getEvaluation_typeByName(Serializable name) {
		...
		return svcevaluation_type.getOne(new QueryWrapper<Evaluation_type>().eq(Evaluation_type.NAME, name).last("limit 1"));
	}
	 ...
	 * @return
	 */
	public PagerList<Evaluation_type> pagerListEvaluation_type(Integer pagenumber, Integer pagesize, String keyword, Map<String, String> sqlin) {
	 ...
	 * @return
	 */
	public PagerList<Evaluation_type> pagerListEvaluation_type(Integer pagenumber, Integer pagesize, String keyword, Map<String, String> sqlin, Map<String, Object> params) {
		List<KeyAndValue> ordlist=new ArrayList<KeyAndValue>();
		ordlist.add(new KeyAndValue(Evaluation_type.ID,  "desc"));
	 ...
	 * @return
	 */
	public PagerList<Evaluation_type> pagerListEvaluation_type(Integer pagenumber, Integer pagesize, String keyword, Map<String, String> sqlin, Map<String, Object> params, List<KeyAndValue> ordlist) {
	...
	public Map<String, Integer> statEvaluation_typeGroupbyId() {
		List<Map<String, Object>> list = svcevaluation_type.listMaps(new QueryWrapper<Evaluation_type>()
		.select(Evaluation_type.NAME, "count(*)")
		.eq(Evaluation_type.NAME, 0)
		.groupBy(Evaluation_type.ID)
		.orderByAsc(Evaluation_type.ID)
		);
	...
	public Experiment getExperimentBySubject_id(Serializable subject_id) {
		...
		return svcexperiment.getOne(new QueryWrapper<Experiment>().eq(Experiment.SUBJECT_ID, subject_id).last("limit 1"));
	}
	 ...
	 * @return
	 */
	public PagerList<Experiment> pagerListExperiment(Integer pagenumber, Integer pagesize, String keyword, Map<String, String> sqlin) {
	 ...
	 * @return
	 */
	public PagerList<Experiment> pagerListExperiment(Integer pagenumber, Integer pagesize, String keyword, Map<String, String> sqlin, Map<String, Object> params) {
		List<KeyAndValue> ordlist=new ArrayList<KeyAndValue>();
		ordlist.add(new KeyAndValue(Experiment.ID,  "desc"));
	 ...
	 * @return
	 */
	public PagerList<Experiment> pagerListExperiment(Integer pagenumber, Integer pagesize, String keyword, Map<String, String> sqlin, Map<String, Object> params, List<KeyAndValue> ordlist) {
		...
		if (StringUtils.isBlank(keyword) && StringUtils.isBlank(subject_id)  && StringUtils.isBlank(curriculum_id) ) {
			...
			if (!StringUtils.isBlank(keyword)) {
				String kwss = keyword;
				queryWrapper.and(wr->wr.like(Experiment.INTRO, kwss)
					.or().like(Experiment.TITLE, kwss)
					.or().like(Experiment.CONTENT, kwss)
					.or().like(Experiment.PURPOSES_REQUIREMENT, kwss)
						);
			}
			// 添加id使用in语句筛选
			if (!StringUtils.isBlank(subject_id)) {
		...
		for (int i = 0; i < list.size(); i++) {
			...
			if (!StringUtils.isBlank(keyword)) {
				...
				try {
					...
					list.get(i).setTitle((list.get(i).getTitle().replace(keyword, Common.getKeywordSpan(keyword))));
					list.get(i).setContent((list.get(i).getContent().replace(keyword, Common.getKeywordSpan(keyword))));
					list.get(i).setPurposes_requirement((list.get(i).getPurposes_requirement().replace(keyword, Common.getKeywordSpan(keyword))));
				} catch (Exception e) {
				    e.printStackTrace();
				}
			}
	 ...
	 * @return 是否成功 
	 */
	public Boolean updateExperimentById(Integer subject_id,Integer curriculum_id,Boolean is_actived,String intro,String title,String content,String purposes_requirement,Integer filesize,Long update_gmt,Integer id) {
	...
	public Map<String, Integer> statExperimentGroupbyId() {
		List<Map<String, Object>> list = svcexperiment.listMaps(new QueryWrapper<Experiment>()
		.select(Experiment.INTRO, "count(*)")
		.eq(Experiment.SUBJECT_ID, 0)
		.groupBy(Experiment.ID)
		.orderByAsc(Experiment.ID)
		);
	...
	public Experiment_record getExperiment_recordByStudent_id(Serializable student_id) {
		...
		return svcexperiment_record.getOne(new QueryWrapper<Experiment_record>().eq(Experiment_record.STUDENT_ID, student_id).last("limit 1"));
	}
	 ...
	 * @return
	 */
	public PagerList<Experiment_record> pagerListExperiment_record(Integer pagenumber, Integer pagesize, String keyword, Map<String, String> sqlin) {
	 ...
	 * @return
	 */
	public PagerList<Experiment_record> pagerListExperiment_record(Integer pagenumber, Integer pagesize, String keyword, Map<String, String> sqlin, Map<String, Object> params) {
		List<KeyAndValue> ordlist=new ArrayList<KeyAndValue>();
		ordlist.add(new KeyAndValue(Experiment_record.ID,  "desc"));
	 ...
	 * @return
	 */
	public PagerList<Experiment_record> pagerListExperiment_record(Integer pagenumber, Integer pagesize, String keyword, Map<String, String> sqlin, Map<String, Object> params, List<KeyAndValue> ordlist) {
		...
		if (StringUtils.isBlank(keyword) && StringUtils.isBlank(student_id)  && StringUtils.isBlank(experiment_id) ) {
			...
			if (!StringUtils.isBlank(keyword)) {
				String kwss = keyword;
				queryWrapper.and(wr->wr.like(Experiment_record.SNO, kwss)
					.or().like(Experiment_record.COMMENT, kwss)
					.or().like(Experiment_record.MAINFLOW, kwss)
					.or().like(Experiment_record.REPORT, kwss)
					.or().like(Experiment_record.RESULT, kwss)
					.or().like(Experiment_record.SCORESCRIPT, kwss)
						);
			}
			// 添加id使用in语句筛选
			if (!StringUtils.isBlank(student_id)) {
		...
		for (int i = 0; i < list.size(); i++) {
			...
			if (!StringUtils.isBlank(keyword)) {
				...
				try {
					...
					list.get(i).setSno((list.get(i).getSno().replace(keyword, Common.getKeywordSpan(keyword))));
					list.get(i).setComment((list.get(i).getComment().replace(keyword, Common.getKeywordSpan(keyword))));
					list.get(i).setMainflow((list.get(i).getMainflow().replace(keyword, Common.getKeywordSpan(keyword))));
					...
					list.get(i).setScorescript((list.get(i).getScorescript().replace(keyword, Common.getKeywordSpan(keyword))));
				} catch (Exception e) {
				    e.printStackTrace();
				}
			}
	 ...
	 * @return 是否成功 
	 */
	public Boolean updateExperiment_recordById(Integer student_id,String sno,Integer experiment_id,String comment,String mainflow,String report,String result,Integer score,Long submit,String scorescript,Integer reviewstate,Long update_gmt,Integer id) {
	...
	public Map<String, Integer> statExperiment_recordGroupbyId() {
		...
		.select(Experiment_record.SNO, "count(*)")
		.eq(Experiment_record.STUDENT_ID, 0)
		.groupBy(Experiment_record.ID)
		.orderByAsc(Experiment_record.ID)
		);
	 ...
	 * @return Link_experiment_curriculum列表 
	 */
	public List<Link_experiment_curriculum> listLink_experiment_curriculumByMap(Map<String, Object> params, List<KeyAndValue> ordlist) {
	...
	public Link_experiment_curriculum getLink_experiment_curriculumByExperiment_id(Serializable experiment_id) {
		...
		return svclink_experiment_curriculum.getOne(new QueryWrapper<Link_experiment_curriculum>().eq(Link_experiment_curriculum.EXPERIMENT_ID, experiment_id).last("limit 1"));
	}
	...
	public Link_experiment_curriculum getLink_experiment_curriculumByMap(Map<String, Object> params) {
		...
		//Map<String, Object> params = new HashMap<String, Object>();
		//params.put(Link_experiment_curriculum.ID, 0);
		return svclink_experiment_curriculum.getOne(new QueryWrapper<Link_experiment_curriculum>().allEq(params).last("limit 1"));
	}
	...
	public List<Link_experiment_curriculum> listLink_experiment_curriculumOrderByAsc(String columnname) {
		...
		return svclink_experiment_curriculum.list(new QueryWrapper<Link_experiment_curriculum>().orderByAsc(columnname));
	}
	...
	public List<Link_experiment_curriculum> listLink_experiment_curriculumOrderByDesc(String columnname) {
		...
		return svclink_experiment_curriculum.list(new QueryWrapper<Link_experiment_curriculum>().orderByDesc(columnname));
	}
	 ...
	 * @return Link_experiment_curriculum列表 
	 */
	public List<Link_experiment_curriculum> listLink_experiment_curriculumByMapAsc(Map<String, Object> params,String columnname) {

		logger.debug(this.getClass().getName() + ".listLink_experiment_curriculumByMapAsc()");
		return svclink_experiment_curriculum.list(new QueryWrapper<Link_experiment_curriculum>().allEq(params).orderByAsc(columnname));
	}
	 ...
	 * @return Link_experiment_curriculum列表 
	 */
	public List<Link_experiment_curriculum> listLink_experiment_curriculumByMapDesc(Map<String, Object> params,String columnname) {

		logger.debug(this.getClass().getName() + ".listLink_experiment_curriculumByMapDesc()");
		return svclink_experiment_curriculum.list(new QueryWrapper<Link_experiment_curriculum>().allEq(params).orderByDesc(columnname));
	}
	 ...
	 * @return
	 */
	public PagerList<Link_experiment_curriculum> pagerListLink_experiment_curriculum(Integer pagenumber, Integer pagesize) {
	 ...
	 * @return
	 */
	public PagerList<Link_experiment_curriculum> pagerListLink_experiment_curriculum(Integer pagenumber, Integer pagesize, String keyword) {
	 ...
	 * @return
	 */
	public PagerList<Link_experiment_curriculum> pagerListLink_experiment_curriculum(Integer pagenumber, Integer pagesize, String keyword, Map<String, String> sqlin) {
	 ...
	 * @return
	 */
	public PagerList<Link_experiment_curriculum> pagerListLink_experiment_curriculum(Integer pagenumber, Integer pagesize, String keyword, Map<String, String> sqlin, Map<String, Object> params) {
		List<KeyAndValue> ordlist=new ArrayList<KeyAndValue>();
	 ...
	 * @return
	 */
	public PagerList<Link_experiment_curriculum> pagerListLink_experiment_curriculum(Integer pagenumber, Integer pagesize, String keyword, Map<String, String> sqlin, Map<String, Object> params, List<KeyAndValue> ordlist) {
		...
		if (StringUtils.isBlank(keyword) && StringUtils.isBlank(experiment_id)  && StringUtils.isBlank(curriculum_id)  && StringUtils.isBlank(subject_id) ) {
	 ...
	 * @return 是否成功 
	 */
	public Boolean updateLink_experiment_curriculumById(Integer experiment_id,Integer curriculum_id,Integer subject_id,Long opening_gmt,Long closing_gmt,Integer sortid,Boolean is_actived,Long update_gmt,Integer id) {
	...
	public Boolean moveLink_experiment_curriculum(String method, String upOrDown, Integer id, String sortColumn) {
		...
		QueryWrapper<Link_experiment_curriculum> queryWrapper = new QueryWrapper<>();
		// 同一个父栏目下
		// queryWrapper.eq(Link_experiment_curriculum.COLUMN_PARENTID , it.getColumn_parentid());
		if (method.equals(upOrDown)) {
			queryWrapper.lt(sortColumn, it.getSortid());
			queryWrapper.orderByDesc(sortColumn);
		} else {
	...
	public Map<String, Integer> statLink_experiment_curriculumGroupbyId() {
		List<Map<String, Object>> list = svclink_experiment_curriculum.listMaps(new QueryWrapper<Link_experiment_curriculum>()
		.select(Link_experiment_curriculum.ID, "count(*)")
		.eq(Link_experiment_curriculum.EXPERIMENT_ID, 0)
		.groupBy(Link_experiment_curriculum.ID)
	...
	public Link_role_permit getLink_role_permitByRole_id(Serializable role_id) {
		...
		return svclink_role_permit.getOne(new QueryWrapper<Link_role_permit>().eq(Link_role_permit.ROLE_ID, role_id).last("limit 1"));
	}
	 ...
	 * @return
	 */
	public PagerList<Link_role_permit> pagerListLink_role_permit(Integer pagenumber, Integer pagesize, String keyword, Map<String, String> sqlin) {
	 ...
	 * @return
	 */
	public PagerList<Link_role_permit> pagerListLink_role_permit(Integer pagenumber, Integer pagesize, String keyword, Map<String, String> sqlin, Map<String, Object> params) {
		List<KeyAndValue> ordlist=new ArrayList<KeyAndValue>();
		ordlist.add(new KeyAndValue(Link_role_permit.ID,  "desc"));
	 ...
	 * @return
	 */
	public PagerList<Link_role_permit> pagerListLink_role_permit(Integer pagenumber, Integer pagesize, String keyword, Map<String, String> sqlin, Map<String, Object> params, List<KeyAndValue> ordlist) {
	 ...
	 * @return 是否成功 
	 */
	public Boolean updateLink_role_permitById(Integer role_id,Integer permit_id,Integer update_userid,Long update_gmt,Integer id) {
	...
	public Map<String, Integer> statLink_role_permitGroupbyId() {
		List<Map<String, Object>> list = svclink_role_permit.listMaps(new QueryWrapper<Link_role_permit>()
		.select(Link_role_permit.ID, "count(*)")
		.eq(Link_role_permit.ROLE_ID, 0)
		.groupBy(Link_role_permit.ID)
		.orderByAsc(Link_role_permit.ID)
		);
	...
	public Link_student2group getLink_student2groupByStudent_id(Serializable student_id) {
		...
		return svclink_student2group.getOne(new QueryWrapper<Link_student2group>().eq(Link_student2group.STUDENT_ID, student_id).last("limit 1"));
	}
	 ...
	 * @return
	 */
	public PagerList<Link_student2group> pagerListLink_student2group(Integer pagenumber, Integer pagesize, String keyword) {
	 ...
	 * @return
	 */
	public PagerList<Link_student2group> pagerListLink_student2group(Integer pagenumber, Integer pagesize, String keyword, Map<String, String> sqlin) {
	 ...
	 * @return
	 */
	public PagerList<Link_student2group> pagerListLink_student2group(Integer pagenumber, Integer pagesize, String keyword, Map<String, String> sqlin, Map<String, Object> params) {
		List<KeyAndValue> ordlist=new ArrayList<KeyAndValue>();
		ordlist.add(new KeyAndValue(Link_student2group.ID,  "desc"));
	 ...
	 * @return
	 */
	public PagerList<Link_student2group> pagerListLink_student2group(Integer pagenumber, Integer pagesize, String keyword, Map<String, String> sqlin, Map<String, Object> params, List<KeyAndValue> ordlist) {
	 ...
	 * @return 是否成功 
	 */
	public Boolean updateLink_student2groupById(Integer student_id,Integer student_group_id,Long update_gmt,Integer id) {
	...
	public Map<String, Integer> statLink_student2groupGroupbyId() {
		...
		.select(Link_student2group.ID, "count(*)")
		.eq(Link_student2group.STUDENT_ID, 0)
		.groupBy(Link_student2group.ID)
		.orderByAsc(Link_student2group.ID)
		);
	...
	public Link_user_role getLink_user_roleByUser_id(Serializable user_id) {
		...
		return svclink_user_role.getOne(new QueryWrapper<Link_user_role>().eq(Link_user_role.USER_ID, user_id).last("limit 1"));
	}
	 ...
	 * @return
	 */
	public PagerList<Link_user_role> pagerListLink_user_role(Integer pagenumber, Integer pagesize, String keyword, Map<String, String> sqlin) {
	 ...
	 * @return
	 */
	public PagerList<Link_user_role> pagerListLink_user_role(Integer pagenumber, Integer pagesize, String keyword, Map<String, String> sqlin, Map<String, Object> params) {
		List<KeyAndValue> ordlist=new ArrayList<KeyAndValue>();
		ordlist.add(new KeyAndValue(Link_user_role.ID,  "desc"));
	 ...
	 * @return
	 */
	public PagerList<Link_user_role> pagerListLink_user_role(Integer pagenumber, Integer pagesize, String keyword, Map<String, String> sqlin, Map<String, Object> params, List<KeyAndValue> ordlist) {
	 ...
	 * @return 是否成功 
	 */
	public Boolean updateLink_user_roleById(Integer user_id,Integer role_id,Integer update_userid,Long update_gmt,Integer id) {
	...
	public Map<String, Integer> statLink_user_roleGroupbyId() {
		List<Map<String, Object>> list = svclink_user_role.listMaps(new QueryWrapper<Link_user_role>()
		.select(Link_user_role.ID, "count(*)")
		.eq(Link_user_role.USER_ID, 0)
		.groupBy(Link_user_role.ID)
		.orderByAsc(Link_user_role.ID)
		);
	 ...
	 * @return
	 */
	public PagerList<Message> pagerListMessage(Integer pagenumber, Integer pagesize, String keyword, Map<String, String> sqlin) {
	 ...
	 * @return
	 */
	public PagerList<Message> pagerListMessage(Integer pagenumber, Integer pagesize, String keyword, Map<String, String> sqlin, Map<String, Object> params) {
		List<KeyAndValue> ordlist=new ArrayList<KeyAndValue>();
		ordlist.add(new KeyAndValue(Message.ID,  "desc"));
	 ...
	 * @return
	 */
	public PagerList<Message> pagerListMessage(Integer pagenumber, Integer pagesize, String keyword, Map<String, String> sqlin, Map<String, Object> params, List<KeyAndValue> ordlist) {
		...
		if (StringUtils.isBlank(keyword)) {
			...
			if (!StringUtils.isBlank(keyword)) {
				String kwss = keyword;
				queryWrapper.and(wr->wr.like(Message.FROM, kwss)
					.or().like(Message.TO, kwss)
					.or().like(Message.USERNAME, kwss)
					.or().like(Message.EMAIL, kwss)
					.or().like(Message.MSG, kwss)
						);
			}
			// 添加id使用in语句筛选
			// --------2.模糊匹配模式---------
		...
		for (int i = 0; i < list.size(); i++) {
			...
			if (!StringUtils.isBlank(keyword)) {
				...
				try {
					...
					list.get(i).setUsername((list.get(i).getUsername().replace(keyword, Common.getKeywordSpan(keyword))));
	 ...
	 * @return 是否成功 
	 */
	public Boolean updateMessageById(String from,String to,String username,String email,String msg,Long update_gmt,Integer id) {
	...
	public Map<String, Integer> statMessageGroupbyId() {
		...
		.select(Message.FROM, "count(*)")
		.eq(Message.FROM, 0)
		.groupBy(Message.ID)
		.orderByAsc(Message.ID)
		);
	 ...
	 * @return
	 */
	public PagerList<Permit> pagerListPermit(Integer pagenumber, Integer pagesize, String keyword, Map<String, String> sqlin) {
	 ...
	 * @return
	 */
	public PagerList<Permit> pagerListPermit(Integer pagenumber, Integer pagesize, String keyword, Map<String, String> sqlin, Map<String, Object> params) {
		List<KeyAndValue> ordlist=new ArrayList<KeyAndValue>();
		ordlist.add(new KeyAndValue(Permit.ID,  "desc"));
	 ...
	 * @return
	 */
	public PagerList<Permit> pagerListPermit(Integer pagenumber, Integer pagesize, String keyword, Map<String, String> sqlin, Map<String, Object> params, List<KeyAndValue> ordlist) {
		...
		if (StringUtils.isBlank(keyword)) {
			...
			if (!StringUtils.isBlank(keyword)) {
				String kwss = keyword;
				queryWrapper.and(wr->wr.like(Permit.TARGET, kwss)
					.or().like(Permit.OPERATION, kwss)
					.or().like(Permit.NAME, kwss)
					.or().like(Permit.CODE, kwss)
						);
			}
			// 添加id使用in语句筛选
			// --------2.模糊匹配模式---------
		...
		for (int i = 0; i < list.size(); i++) {
			...
			if (!StringUtils.isBlank(keyword)) {
				...
				try {
					...
					list.get(i).setOperation((list.get(i).getOperation().replace(keyword, Common.getKeywordSpan(keyword))));
					list.get(i).setName((list.get(i).getName().replace(keyword, Common.getKeywordSpan(keyword))));
	 ...
	 * @return 是否成功 
	 */
	public Boolean updatePermitById(String target,String operation,String name,String code,Integer update_userid,Long update_gmt,Integer id) {
	...
	public Map<String, Integer> statPermitGroupbyId() {
		List<Map<String, Object>> list = svcpermit.listMaps(new QueryWrapper<Permit>()
		.select(Permit.TARGET, "count(*)")
		.eq(Permit.CREATE_USERID, 0)
		.groupBy(Permit.ID)
		.orderByAsc(Permit.ID)
		);
	 ...
	 * @return
	 */
	public PagerList<Role> pagerListRole(Integer pagenumber, Integer pagesize, String keyword, Map<String, String> sqlin) {
	 ...
	 * @return
	 */
	public PagerList<Role> pagerListRole(Integer pagenumber, Integer pagesize, String keyword, Map<String, String> sqlin, Map<String, Object> params) {
		List<KeyAndValue> ordlist=new ArrayList<KeyAndValue>();
		ordlist.add(new KeyAndValue(Role.ID,  "desc"));
	 ...
	 * @return
	 */
	public PagerList<Role> pagerListRole(Integer pagenumber, Integer pagesize, String keyword, Map<String, String> sqlin, Map<String, Object> params, List<KeyAndValue> ordlist) {
		...
		if (StringUtils.isBlank(keyword)) {
			...
			if (!StringUtils.isBlank(keyword)) {
				String kwss = keyword;
				queryWrapper.and(wr->wr.like(Role.NAME, kwss)
					.or().like(Role.ALIAS, kwss)
					.or().like(Role.REMARK, kwss)
						);
			}
			// 添加id使用in语句筛选
			// --------2.模糊匹配模式---------
	 ...
	 * @return 是否成功 
	 */
	public Boolean updateRoleById(String name,String alias,Boolean is_system,Boolean is_actived,String remark,Integer update_userid,Long update_gmt,Integer id) {
	...
	public Map<String, Integer> statRoleGroupbyId() {
		List<Map<String, Object>> list = svcrole.listMaps(new QueryWrapper<Role>()
		.select(Role.NAME, "count(*)")
		.eq(Role.CREATE_USERID, 0)
		.groupBy(Role.ID)
		.orderByAsc(Role.ID)
		);
	 ...
	 * @return
	 */
	public PagerList<Statistic> pagerListStatistic(Integer pagenumber, Integer pagesize, String keyword, Map<String, String> sqlin) {
	 ...
	 * @return
	 */
	public PagerList<Statistic> pagerListStatistic(Integer pagenumber, Integer pagesize, String keyword, Map<String, String> sqlin, Map<String, Object> params) {
		List<KeyAndValue> ordlist=new ArrayList<KeyAndValue>();
		ordlist.add(new KeyAndValue(Statistic.ID,  "desc"));
	 ...
	 * @return
	 */
	public PagerList<Statistic> pagerListStatistic(Integer pagenumber, Integer pagesize, String keyword, Map<String, String> sqlin, Map<String, Object> params, List<KeyAndValue> ordlist) {
	...
	public Map<String, Integer> statStatisticGroupbyId() {
		List<Map<String, Object>> list = svcstatistic.listMaps(new QueryWrapper<Statistic>()
		.select(Statistic.ST_DATE, "count(*)")
		.eq(Statistic.ST_TOTAL, 0)
		.groupBy(Statistic.ID)
		.orderByAsc(Statistic.ID)
		);
	 ...
	 * @return
	 */
	public PagerList<Student> pagerListStudent(Integer pagenumber, Integer pagesize, String keyword, Map<String, String> sqlin) {
	 ...
	 * @return
	 */
	public PagerList<Student> pagerListStudent(Integer pagenumber, Integer pagesize, String keyword, Map<String, String> sqlin, Map<String, Object> params) {
		List<KeyAndValue> ordlist=new ArrayList<KeyAndValue>();
		ordlist.add(new KeyAndValue(Student.ID,  "desc"));
	 ...
	 * @return
	 */
	public PagerList<Student> pagerListStudent(Integer pagenumber, Integer pagesize, String keyword, Map<String, String> sqlin, Map<String, Object> params, List<KeyAndValue> ordlist) {
		...
		if (StringUtils.isBlank(keyword)) {
			...
			if (!StringUtils.isBlank(keyword)) {
				String kwss = keyword;
				queryWrapper.and(wr->wr.like(Student.SNO, kwss)
					.or().like(Student.LOGIN_NAME, kwss)
					.or().like(Student.LOGIN_PASSWORD, kwss)
					.or().like(Student.NAME, kwss)
					.or().like(Student.EMAIL, kwss)
					.or().like(Student.MOBILE, kwss)
					.or().like(Student.QQ, kwss)
					.or().like(Student.WECHAT_OPENID, kwss)
					.or().like(Student.WECHAT_NICKNAME, kwss)
					.or().like(Student.WECHAT_HEADIMGURL, kwss)
					.or().like(Student.CLASSCODE, kwss)
						);
			}
			// 添加id使用in语句筛选
			// --------2.模糊匹配模式---------
		...
		for (int i = 0; i < list.size(); i++) {
			...
			if (!StringUtils.isBlank(keyword)) {
				...
				try {
					...
					list.get(i).setSno((list.get(i).getSno().replace(keyword, Common.getKeywordSpan(keyword))));
					list.get(i).setLogin_name((list.get(i).getLogin_name().replace(keyword, Common.getKeywordSpan(keyword))));
					list.get(i).setLogin_name_digest((list.get(i).getLogin_name_digest().replace(keyword, Common.getKeywordSpan(keyword))));
					list.get(i).setLogin_password((list.get(i).getLogin_password().replace(keyword, Common.getKeywordSpan(keyword))));
					list.get(i).setLogin_password_digest((list.get(i).getLogin_password_digest().replace(keyword, Common.getKeywordSpan(keyword))));
					list.get(i).setName((list.get(i).getName().replace(keyword, Common.getKeywordSpan(keyword))));
					list.get(i).setEmail((list.get(i).getEmail().replace(keyword, Common.getKeywordSpan(keyword))));
					...
					list.get(i).setWechat_openid((list.get(i).getWechat_openid().replace(keyword, Common.getKeywordSpan(keyword))));
					list.get(i).setWechat_nickname((list.get(i).getWechat_nickname().replace(keyword, Common.getKeywordSpan(keyword))));
					list.get(i).setWechat_headimgurl((list.get(i).getWechat_headimgurl().replace(keyword, Common.getKeywordSpan(keyword))));
					list.get(i).setClasscode((list.get(i).getClasscode().replace(keyword, Common.getKeywordSpan(keyword))));
				} catch (Exception e) {
				    e.printStackTrace();
				}
			}
	 ...
	 * @return 是否成功 
	 */
	public Boolean updateStudentById(String sno,String login_name,String login_name_digest,String login_password,String login_password_digest,String name,String email,Boolean is_actived,String mobile,String qq,String wechat_openid,String wechat_nickname,String wechat_headimgurl,Integer login_method,String classcode,Long update_gmt,Integer id) {
	...
	public Map<String, Integer> statStudentGroupbyId() {
		List<Map<String, Object>> list = svcstudent.listMaps(new QueryWrapper<Student>()
		.select(Student.SNO, "count(*)")
		.eq(Student.LOGIN_METHOD, 0)
		.groupBy(Student.ID)
		.orderByAsc(Student.ID)
		);
	...
	public Student_group getStudent_groupByIs_actived(Serializable is_actived) {
		...
		return svcstudent_group.getOne(new QueryWrapper<Student_group>().eq(Student_group.IS_ACTIVED, is_actived).last("limit 1"));
	}
	 ...
	 * @return
	 */
	public PagerList<Student_group> pagerListStudent_group(Integer pagenumber, Integer pagesize, String keyword, Map<String, String> sqlin) {
	 ...
	 * @return
	 */
	public PagerList<Student_group> pagerListStudent_group(Integer pagenumber, Integer pagesize, String keyword, Map<String, String> sqlin, Map<String, Object> params) {
		List<KeyAndValue> ordlist=new ArrayList<KeyAndValue>();
		ordlist.add(new KeyAndValue(Student_group.ID,  "desc"));
	 ...
	 * @return
	 */
	public PagerList<Student_group> pagerListStudent_group(Integer pagenumber, Integer pagesize, String keyword, Map<String, String> sqlin, Map<String, Object> params, List<KeyAndValue> ordlist) {
		...
		if (StringUtils.isBlank(keyword)) {
			...
			if (!StringUtils.isBlank(keyword)) {
				String kwss = keyword;
				queryWrapper.and(wr->wr.like(Student_group.CODE, kwss)
					.or().like(Student_group.NAME, kwss)
						);
			}
			// 添加id使用in语句筛选
			// --------2.模糊匹配模式---------
	...
	public Map<String, Integer> statStudent_groupGroupbyId() {
		List<Map<String, Object>> list = svcstudent_group.listMaps(new QueryWrapper<Student_group>()
		.select(Student_group.CODE, "count(*)")
		.eq(Student_group.IS_ACTIVED, 0)
		.groupBy(Student_group.ID)
		.orderByAsc(Student_group.ID)
		);
	 ...
	 * @return
	 */
	public PagerList<Subject> pagerListSubject(Integer pagenumber, Integer pagesize, String keyword, Map<String, String> sqlin) {
	 ...
	 * @return
	 */
	public PagerList<Subject> pagerListSubject(Integer pagenumber, Integer pagesize, String keyword, Map<String, String> sqlin, Map<String, Object> params) {
		List<KeyAndValue> ordlist=new ArrayList<KeyAndValue>();
	 ...
	 * @return
	 */
	public PagerList<Subject> pagerListSubject(Integer pagenumber, Integer pagesize, String keyword, Map<String, String> sqlin, Map<String, Object> params, List<KeyAndValue> ordlist) {
		...
		if (StringUtils.isBlank(keyword)) {
			...
			if (!StringUtils.isBlank(keyword)) {
				String kwss = keyword;
				queryWrapper.and(wr->wr.like(Subject.INTRO, kwss)
					.or().like(Subject.NAME, kwss)
					.or().like(Subject.ILLUSTRATION, kwss)
						);
			}
			// 添加id使用in语句筛选
			// --------2.模糊匹配模式---------
		...
		for (int i = 0; i < list.size(); i++) {
			...
			if (!StringUtils.isBlank(keyword)) {
				...
				try {
					...
					list.get(i).setIntro((list.get(i).getIntro().replace(keyword, Common.getKeywordSpan(keyword))));
					list.get(i).setName((list.get(i).getName().replace(keyword, Common.getKeywordSpan(keyword))));
					list.get(i).setIllustration((list.get(i).getIllustration().replace(keyword, Common.getKeywordSpan(keyword))));
				} catch (Exception e) {
				    e.printStackTrace();
				}
			}
	 ...
	 * @return 是否成功 
	 */
	public Boolean updateSubjectById(Boolean is_actived,Integer sortid,String intro,String name,String illustration,Long update_gmt,Integer id) {
	...
	public Map<String, Integer> statSubjectGroupbyId() {
		...
		.select(Subject.INTRO, "count(*)")
		.eq(Subject.SORTID, 0)
		.groupBy(Subject.ID)
		.orderByAsc(Subject.ID)
		);
	 ...
	 * @return
	 */
	public PagerList<Syslog> pagerListSyslog(Integer pagenumber, Integer pagesize, String keyword, Map<String, String> sqlin) {
	 ...
	 * @return
	 */
	public PagerList<Syslog> pagerListSyslog(Integer pagenumber, Integer pagesize, String keyword, Map<String, String> sqlin, Map<String, Object> params) {
		List<KeyAndValue> ordlist=new ArrayList<KeyAndValue>();
		ordlist.add(new KeyAndValue(Syslog.ID,  "desc"));
	 ...
	 * @return
	 */
	public PagerList<Syslog> pagerListSyslog(Integer pagenumber, Integer pagesize, String keyword, Map<String, String> sqlin, Map<String, Object> params, List<KeyAndValue> ordlist) {
		...
		if (StringUtils.isBlank(keyword) && StringUtils.isBlank(user_id) ) {
			...
			if (!StringUtils.isBlank(keyword)) {
				String kwss = keyword;
				queryWrapper.and(wr->wr.like(Syslog.USER_INFO, kwss)
					.or().like(Syslog.USER_IP, kwss)
					.or().like(Syslog.REQUEST_CONTENT, kwss)
					.or().like(Syslog.URL, kwss)
						);
			}
			// 添加id使用in语句筛选
			if (!StringUtils.isBlank(user_id)) {
		...
		for (int i = 0; i < list.size(); i++) {
			...
			if (!StringUtils.isBlank(keyword)) {
				...
				try {
					...
					list.get(i).setUser_info((list.get(i).getUser_info().replace(keyword, Common.getKeywordSpan(keyword))));
					list.get(i).setUser_ip((list.get(i).getUser_ip().replace(keyword, Common.getKeywordSpan(keyword))));
					list.get(i).setRequest_content((list.get(i).getRequest_content().replace(keyword, Common.getKeywordSpan(keyword))));
	 ...
	 * @return 是否成功 
	 */
	public Boolean updateSyslogById(Integer user_id,String user_info,String user_ip,Integer spend_time,String request_content,String url,Boolean is_attack,Integer id) {
	...
	public Map<String, Integer> statSyslogGroupbyId() {
		...
		.select(Syslog.USER_INFO, "count(*)")
		.eq(Syslog.USER_ID, 0)
		.groupBy(Syslog.ID)
		.orderByAsc(Syslog.ID)
		);
	 ...
	 * @return
	 */
	public PagerList<User> pagerListUser(Integer pagenumber, Integer pagesize, String keyword, Map<String, String> sqlin) {
	 ...
	 * @return
	 */
	public PagerList<User> pagerListUser(Integer pagenumber, Integer pagesize, String keyword, Map<String, String> sqlin, Map<String, Object> params) {
		List<KeyAndValue> ordlist=new ArrayList<KeyAndValue>();
		ordlist.add(new KeyAndValue(User.ID,  "desc"));
	 ...
	 * @return
	 */
	public PagerList<User> pagerListUser(Integer pagenumber, Integer pagesize, String keyword, Map<String, String> sqlin, Map<String, Object> params, List<KeyAndValue> ordlist) {
		...
		if (StringUtils.isBlank(keyword)) {
			...
			if (!StringUtils.isBlank(keyword)) {
				String kwss = keyword;
				queryWrapper.and(wr->wr.like(User.NAME, kwss)
					.or().like(User.LOGIN_NAME, kwss)
					.or().like(User.LOGIN_PASSWORD, kwss)
					.or().like(User.EMAIL, kwss)
					.or().like(User.TELEPHONE, kwss)
					.or().like(User.QQ, kwss)
					.or().like(User.WECHAT_OPENID, kwss)
					.or().like(User.WECHAT_NICKNAME, kwss)
					.or().like(User.WECHAT_HEADIMGURL, kwss)
						);
			}
			// 添加id使用in语句筛选
			// --------2.模糊匹配模式---------
		...
		for (int i = 0; i < list.size(); i++) {
			...
			if (!StringUtils.isBlank(keyword)) {
				...
				try {
					...
					list.get(i).setLogin_password_digest((list.get(i).getLogin_password_digest().replace(keyword, Common.getKeywordSpan(keyword))));
					list.get(i).setEmail((list.get(i).getEmail().replace(keyword, Common.getKeywordSpan(keyword))));
					list.get(i).setTelephone((list.get(i).getTelephone().replace(keyword, Common.getKeywordSpan(keyword))));
					list.get(i).setQq((list.get(i).getQq().replace(keyword, Common.getKeywordSpan(keyword))));
					list.get(i).setWechat_openid((list.get(i).getWechat_openid().replace(keyword, Common.getKeywordSpan(keyword))));
					list.get(i).setWechat_nickname((list.get(i).getWechat_nickname().replace(keyword, Common.getKeywordSpan(keyword))));
					list.get(i).setWechat_headimgurl((list.get(i).getWechat_headimgurl().replace(keyword, Common.getKeywordSpan(keyword))));
	 ...
	 * @return 是否成功 
	 */
	public Boolean updateUserById(String name,String login_name,String login_name_digest,String login_password,String login_password_digest,String email,Boolean is_actived,String telephone,String qq,String wechat_openid,String wechat_nickname,String wechat_headimgurl,Integer login_method,Integer update_userid,Long update_gmt,Integer id) {
	...
	public Map<String, Integer> statUserGroupbyId() {
		List<Map<String, Object>> list = svcuser.listMaps(new QueryWrapper<User>()
		.select(User.NAME, "count(*)")
		.eq(User.LOGIN_METHOD, 0)
		.groupBy(User.ID)
		.orderByAsc(User.ID)
		);
	...
	public User_login_log getUser_login_logByUser_id(Serializable user_id) {
		...
		return svcuser_login_log.getOne(new QueryWrapper<User_login_log>().eq(User_login_log.USER_ID, user_id).last("limit 1"));
	}
	 ...
	 * @return
	 */
	public PagerList<User_login_log> pagerListUser_login_log(Integer pagenumber, Integer pagesize, String keyword, Map<String, String> sqlin) {
	 ...
	 * @return
	 */
	public PagerList<User_login_log> pagerListUser_login_log(Integer pagenumber, Integer pagesize, String keyword, Map<String, String> sqlin, Map<String, Object> params) {
		List<KeyAndValue> ordlist=new ArrayList<KeyAndValue>();
		ordlist.add(new KeyAndValue(User_login_log.ID,  "desc"));
	 ...
	 * @return
	 */
	public PagerList<User_login_log> pagerListUser_login_log(Integer pagenumber, Integer pagesize, String keyword, Map<String, String> sqlin, Map<String, Object> params, List<KeyAndValue> ordlist) {
		...
		if (StringUtils.isBlank(keyword) && StringUtils.isBlank(user_id) ) {
			...
			if (!StringUtils.isBlank(keyword)) {
				String kwss = keyword;
				queryWrapper.and(wr->wr.like(User_login_log.USER_IP, kwss)
					.or().like(User_login_log.OPERATING_SYSTEM, kwss)
					.or().like(User_login_log.BROWSER, kwss)
						);
			}
			// 添加id使用in语句筛选
			if (!StringUtils.isBlank(user_id)) {
		...
		for (int i = 0; i < list.size(); i++) {
			...
			if (!StringUtils.isBlank(keyword)) {
				...
				try {
					...
					list.get(i).setUser_ip((list.get(i).getUser_ip().replace(keyword, Common.getKeywordSpan(keyword))));
					list.get(i).setOperating_system((list.get(i).getOperating_system().replace(keyword, Common.getKeywordSpan(keyword))));
	 ...
	 * @return 是否成功 
	 */
	public Boolean updateUser_login_logById(Long login_gmt,String user_ip,Integer user_id,String operating_system,String browser,Integer id) {
	...
	public Map<String, Integer> statUser_login_logGroupbyId() {
		List<Map<String, Object>> list = svcuser_login_log.listMaps(new QueryWrapper<User_login_log>()
		.select(User_login_log.USER_IP, "count(*)")
		.eq(User_login_log.USER_ID, 0)
		.groupBy(User_login_log.ID)
		.orderByAsc(User_login_log.ID)
		);
	...
	public Vcurriculum getVcurriculumBySubject_id(Serializable subject_id) {
		...
		return svcvcurriculum.getOne(new QueryWrapper<Vcurriculum>().eq(Vcurriculum.SUBJECT_ID, subject_id).last("limit 1"));
	}
	 ...
	 * @return
	 */
	public PagerList<Vcurriculum> pagerListVcurriculum(Integer pagenumber, Integer pagesize, String keyword, Map<String, String> sqlin) {
	 ...
	 * @return
	 */
	public PagerList<Vcurriculum> pagerListVcurriculum(Integer pagenumber, Integer pagesize, String keyword, Map<String, String> sqlin, Map<String, Object> params) {
		List<KeyAndValue> ordlist=new ArrayList<KeyAndValue>();
		ordlist.add(new KeyAndValue(Vcurriculum.ID,  "desc"));
	 ...
	 * @return
	 */
	public PagerList<Vcurriculum> pagerListVcurriculum(Integer pagenumber, Integer pagesize, String keyword, Map<String, String> sqlin, Map<String, Object> params, List<KeyAndValue> ordlist) {
		...
		if (StringUtils.isBlank(keyword) && StringUtils.isBlank(subject_id)  && StringUtils.isBlank(student_group_id)  && StringUtils.isBlank(user_id) ) {
			...
			if (!StringUtils.isBlank(keyword)) {
				String kwss = keyword;
				queryWrapper.and(wr->wr.like(Vcurriculum.SEMESTER, kwss)
					.or().like(Vcurriculum.SUBJECT_NAME, kwss)
					.or().like(Vcurriculum.STUDENT_GROUP_NAME, kwss)
					.or().like(Vcurriculum.USER_NAME, kwss)
						);
			}
			// 添加id使用in语句筛选
			if (!StringUtils.isBlank(subject_id)) {
		...
		for (int i = 0; i < list.size(); i++) {
			...
			if (!StringUtils.isBlank(keyword)) {
				...
				try {
					...
					list.get(i).setSemester((list.get(i).getSemester().replace(keyword, Common.getKeywordSpan(keyword))));
					list.get(i).setSubject_name((list.get(i).getSubject_name().replace(keyword, Common.getKeywordSpan(keyword))));
					list.get(i).setStudent_group_name((list.get(i).getStudent_group_name().replace(keyword, Common.getKeywordSpan(keyword))));
					list.get(i).setUser_name((list.get(i).getUser_name().replace(keyword, Common.getKeywordSpan(keyword))));
				} catch (Exception e) {
				    e.printStackTrace();
				}
			}
	 ...
	 * @return 是否成功 
	 */
	public Boolean updateVcurriculumById(Integer subject_id,Integer student_group_id,Integer user_id,String semester,Boolean is_actived,String subject_name,String student_group_name,String user_name,Integer id) {
	...
	public Map<String, Integer> statVcurriculumGroupbyId() {
		List<Map<String, Object>> list = svcvcurriculum.listMaps(new QueryWrapper<Vcurriculum>()
		.select(Vcurriculum.SEMESTER, "count(*)")
		.eq(Vcurriculum.SUBJECT_ID, 0)
		.groupBy(Vcurriculum.ID)
		.orderByAsc(Vcurriculum.ID)
		);
	 ...
	 * @return
	 */
	public PagerList<Vevaluation> pagerListVevaluation(Integer pagenumber, Integer pagesize, String keyword, Map<String, String> sqlin) {
	 ...
	 * @return
	 */
	public PagerList<Vevaluation> pagerListVevaluation(Integer pagenumber, Integer pagesize, String keyword, Map<String, String> sqlin, Map<String, Object> params) {
		List<KeyAndValue> ordlist=new ArrayList<KeyAndValue>();
		ordlist.add(new KeyAndValue(Vevaluation.ID,  "desc"));
	 ...
	 * @return
	 */
	public PagerList<Vevaluation> pagerListVevaluation(Integer pagenumber, Integer pagesize, String keyword, Map<String, String> sqlin, Map<String, Object> params, List<KeyAndValue> ordlist) {
		...
		if (StringUtils.isBlank(keyword) && StringUtils.isBlank(curriculum_id)  && StringUtils.isBlank(subject_id)  && StringUtils.isBlank(student_group_id) ) {
			...
			if (!StringUtils.isBlank(keyword)) {
				String kwss = keyword;
				queryWrapper.and(wr->wr.like(Vevaluation.CONTENT, kwss)
					.or().like(Vevaluation.TITLE, kwss)
					.or().like(Vevaluation.SUBJECT_NAME, kwss)
					.or().like(Vevaluation.STUDENT_GROUP_NAME, kwss)
					.or().like(Vevaluation.STUDENT_GROUP_CODE, kwss)
						);
			}
			// 添加id使用in语句筛选
			if (!StringUtils.isBlank(curriculum_id)) {
		...
		for (int i = 0; i < list.size(); i++) {
			...
			if (!StringUtils.isBlank(keyword)) {
				...
				try {
					...
					list.get(i).setSubject_name((list.get(i).getSubject_name().replace(keyword, Common.getKeywordSpan(keyword))));
					list.get(i).setStudent_group_name((list.get(i).getStudent_group_name().replace(keyword, Common.getKeywordSpan(keyword))));
					list.get(i).setStudent_group_code((list.get(i).getStudent_group_code().replace(keyword, Common.getKeywordSpan(keyword))));
				} catch (Exception e) {
				    e.printStackTrace();
				}
			}
	 ...
	 * @return 是否成功 
	 */
	public Boolean updateVevaluationById(Boolean is_actived,Long begin_gmt,Long end_gmt,String content,String title,Integer sortid,Integer curriculum_id,Long update_gmt,Integer subject_id,String subject_name,Integer student_group_id,String student_group_name,String student_group_code,Integer id) {
	...
	public Map<String, Integer> statVevaluationGroupbyId() {
		List<Map<String, Object>> list = svcvevaluation.listMaps(new QueryWrapper<Vevaluation>()
		.select(Vevaluation.CONTENT, "count(*)")
		.eq(Vevaluation.SORTID, 0)
		.groupBy(Vevaluation.ID)
		.orderByAsc(Vevaluation.ID)
		);
	...
	public Vevaluation_point getVevaluation_pointBySubject_id(Serializable subject_id) {
		...
		return svcvevaluation_point.getOne(new QueryWrapper<Vevaluation_point>().eq(Vevaluation_point.SUBJECT_ID, subject_id).last("limit 1"));
	}
	 ...
	 * @return
	 */
	public PagerList<Vevaluation_point> pagerListVevaluation_point(Integer pagenumber, Integer pagesize, String keyword, Map<String, String> sqlin) {
	 ...
	 * @return
	 */
	public PagerList<Vevaluation_point> pagerListVevaluation_point(Integer pagenumber, Integer pagesize, String keyword, Map<String, String> sqlin, Map<String, Object> params) {
		List<KeyAndValue> ordlist=new ArrayList<KeyAndValue>();
		ordlist.add(new KeyAndValue(Vevaluation_point.ID,  "desc"));
	 ...
	 * @return
	 */
	public PagerList<Vevaluation_point> pagerListVevaluation_point(Integer pagenumber, Integer pagesize, String keyword, Map<String, String> sqlin, Map<String, Object> params, List<KeyAndValue> ordlist) {
		...
		if (StringUtils.isBlank(keyword) && StringUtils.isBlank(subject_id) ) {
			...
			if (!StringUtils.isBlank(keyword)) {
				String kwss = keyword;
				queryWrapper.and(wr->wr.like(Vevaluation_point.CONTENT, kwss)
					.or().like(Vevaluation_point.SUBJECT_NAME, kwss)
		...
		for (int i = 0; i < list.size(); i++) {
			...
			if (!StringUtils.isBlank(keyword)) {
				...
				try {
					...
					list.get(i).setContent((list.get(i).getContent().replace(keyword, Common.getKeywordSpan(keyword))));
					list.get(i).setSubject_name((list.get(i).getSubject_name().replace(keyword, Common.getKeywordSpan(keyword))));
					list.get(i).setEvaluation_type_name((list.get(i).getEvaluation_type_name().replace(keyword, Common.getKeywordSpan(keyword))));
				} catch (Exception e) {
				    e.printStackTrace();
				}
			}
	 ...
	 * @return 是否成功 
	 */
	public Boolean updateVevaluation_pointById(Integer subject_id,Boolean is_actived,Integer type,Integer difficulty,String content,Long update_gmt,String subject_name,String evaluation_type_name,Boolean subject_is_actived,Integer id) {
	...
	public Map<String, Integer> statVevaluation_pointGroupbyId() {
		...
		.select(Vevaluation_point.CONTENT, "count(*)")
		.eq(Vevaluation_point.SUBJECT_ID, 0)
		.groupBy(Vevaluation_point.ID)
		.orderByAsc(Vevaluation_point.ID)
		);
	...
	public Vexperiment_record getVexperiment_recordByStudent_id(Serializable student_id) {
		...
		return svcvexperiment_record.getOne(new QueryWrapper<Vexperiment_record>().eq(Vexperiment_record.STUDENT_ID, student_id).last("limit 1"));
	}
	 ...
	 * @return
	 */
	public PagerList<Vexperiment_record> pagerListVexperiment_record(Integer pagenumber, Integer pagesize, String keyword) {
	 ...
	 * @return
	 */
	public PagerList<Vexperiment_record> pagerListVexperiment_record(Integer pagenumber, Integer pagesize, String keyword, Map<String, String> sqlin) {
	 ...
	 * @return
	 */
	public PagerList<Vexperiment_record> pagerListVexperiment_record(Integer pagenumber, Integer pagesize, String keyword, Map<String, String> sqlin, Map<String, Object> params) {
		List<KeyAndValue> ordlist=new ArrayList<KeyAndValue>();
		ordlist.add(new KeyAndValue(Vexperiment_record.ID,  "desc"));
	 ...
	 * @return
	 */
	public PagerList<Vexperiment_record> pagerListVexperiment_record(Integer pagenumber, Integer pagesize, String keyword, Map<String, String> sqlin, Map<String, Object> params, List<KeyAndValue> ordlist) {
		...
		if (StringUtils.isBlank(keyword) && StringUtils.isBlank(student_id)  && StringUtils.isBlank(experiment_id)  && StringUtils.isBlank(curriculum_id)  && StringUtils.isBlank(subject_id)  && StringUtils.isBlank(user_id)  && StringUtils.isBlank(student_group_id) ) {
			...
			if (!StringUtils.isBlank(keyword)) {
				String kwss = keyword;
				queryWrapper.and(wr->wr.like(Vexperiment_record.TRUENAME, kwss)
					.or().like(Vexperiment_record.SNO, kwss)
					.or().like(Vexperiment_record.SNO_EXP, kwss)
					.or().like(Vexperiment_record.CLASSCODE, kwss)
					.or().like(Vexperiment_record.STUDENT_GROUP_CODE, kwss)
					.or().like(Vexperiment_record.STUDENT_GROUP_NAME, kwss)
					.or().like(Vexperiment_record.COMMENT, kwss)
					.or().like(Vexperiment_record.MAINFLOW, kwss)
					.or().like(Vexperiment_record.REPORT, kwss)
					.or().like(Vexperiment_record.RESULT, kwss)
					.or().like(Vexperiment_record.SCORESCRIPT, kwss)
					.or().like(Vexperiment_record.WECHAT_OPENID, kwss)
					.or().like(Vexperiment_record.EXPERIMENT_TITLE, kwss)
					.or().like(Vexperiment_record.EXPERIMENT_CONTENT, kwss)
					.or().like(Vexperiment_record.EXPERIMENT_PURPOSES_REQUIREMENT, kwss)
					.or().like(Vexperiment_record.SUBJECT_NAME, kwss)
						);
			}
			// 添加id使用in语句筛选
			if (!StringUtils.isBlank(student_id)) {
		...
		for (int i = 0; i < list.size(); i++) {
			...
			if (!StringUtils.isBlank(keyword)) {
				...
				try {
					...
					list.get(i).setTruename((list.get(i).getTruename().replace(keyword, Common.getKeywordSpan(keyword))));
					list.get(i).setSno((list.get(i).getSno().replace(keyword, Common.getKeywordSpan(keyword))));
					...
					list.get(i).setScorescript((list.get(i).getScorescript().replace(keyword, Common.getKeywordSpan(keyword))));
					list.get(i).setWechat_openid((list.get(i).getWechat_openid().replace(keyword, Common.getKeywordSpan(keyword))));
					list.get(i).setExperiment_title((list.get(i).getExperiment_title().replace(keyword, Common.getKeywordSpan(keyword))));
					list.get(i).setExperiment_content((list.get(i).getExperiment_content().replace(keyword, Common.getKeywordSpan(keyword))));
					list.get(i).setExperiment_purposes_requirement((list.get(i).getExperiment_purposes_requirement().replace(keyword, Common.getKeywordSpan(keyword))));
					list.get(i).setSubject_name((list.get(i).getSubject_name().replace(keyword, Common.getKeywordSpan(keyword))));
				} catch (Exception e) {
				    e.printStackTrace();
				}
	 ...
	 * @return 是否成功 
	 */
	public Boolean updateVexperiment_recordById(Integer student_id,Integer experiment_id,Integer curriculum_id,String truename,String sno,String sno_exp,String classcode,Integer score,Boolean student_group_is_actived,Boolean student_is_actived,Boolean curriculum_is_actived,Boolean experiment_curriculum_is_actived,Boolean subject_is_actived,String student_group_code,String student_group_name,String comment,String mainflow,String report,String result,Long submit,String scorescript,Long update_gmt,String wechat_openid,String experiment_title,String experiment_content,String experiment_purposes_requirement,String subject_name,Integer subject_id,Integer user_id,Long closing_gmt,Long opening_gmt,Integer curriculum_student_groupid,Integer student_group_id,Integer reviewstate,Integer experiment_curriculumid,Integer id) {
	...
	public Map<String, Integer> statVexperiment_recordGroupbyId() {
		...
		.select(Vexperiment_record.TRUENAME, "count(*)")
		.eq(Vexperiment_record.STUDENT_ID, 0)
		.groupBy(Vexperiment_record.ID)
		.orderByAsc(Vexperiment_record.ID)
		);
	 ...
	 * @return Vexperiment_record_mini列表 
	 */
	public List<Vexperiment_record_mini> listVexperiment_record_miniByMap(Map<String, Object> params, List<KeyAndValue> ordlist) {
	...
	public Vexperiment_record_mini getVexperiment_record_miniByStudent_id(Serializable student_id) {
		...
		return svcvexperiment_record_mini.getOne(new QueryWrapper<Vexperiment_record_mini>().eq(Vexperiment_record_mini.STUDENT_ID, student_id).last("limit 1"));
	}
	...
	public Vexperiment_record_mini getVexperiment_record_miniByMap(Map<String, Object> params) {
		...
		//Map<String, Object> params = new HashMap<String, Object>();
		//params.put(Vexperiment_record_mini.ID, 0);
		return svcvexperiment_record_mini.getOne(new QueryWrapper<Vexperiment_record_mini>().allEq(params).last("limit 1"));
	}
	 ...
	 * @return Vexperiment_record_mini列表 
	 */
	public List<Vexperiment_record_mini> listVexperiment_record_miniByMapAsc(Map<String, Object> params,String columnname) {

		logger.debug(this.getClass().getName() + ".listVexperiment_record_miniByMapAsc()");
		return svcvexperiment_record_mini.list(new QueryWrapper<Vexperiment_record_mini>().allEq(params).orderByAsc(columnname));
	}
	 ...
	 * @return Vexperiment_record_mini列表 
	 */
	public List<Vexperiment_record_mini> listVexperiment_record_miniByMapDesc(Map<String, Object> params,String columnname) {

		logger.debug(this.getClass().getName() + ".listVexperiment_record_miniByMapDesc()");
		return svcvexperiment_record_mini.list(new QueryWrapper<Vexperiment_record_mini>().allEq(params).orderByDesc(columnname));
	}
	 ...
	 * @return
	 */
	public PagerList<Vexperiment_record_mini> pagerListVexperiment_record_mini(Integer pagenumber, Integer pagesize, String keyword) {
	 ...
	 * @return
	 */
	public PagerList<Vexperiment_record_mini> pagerListVexperiment_record_mini(Integer pagenumber, Integer pagesize, String keyword, Map<String, String> sqlin) {
	 ...
	 * @return
	 */
	public PagerList<Vexperiment_record_mini> pagerListVexperiment_record_mini(Integer pagenumber, Integer pagesize, String keyword, Map<String, String> sqlin, Map<String, Object> params) {
		List<KeyAndValue> ordlist=new ArrayList<KeyAndValue>();
		ordlist.add(new KeyAndValue(Vexperiment_record_mini.ID,  "desc"));
	 ...
	 * @return
	 */
	public PagerList<Vexperiment_record_mini> pagerListVexperiment_record_mini(Integer pagenumber, Integer pagesize, String keyword, Map<String, String> sqlin, Map<String, Object> params, List<KeyAndValue> ordlist) {
		...
		if (StringUtils.isBlank(keyword) && StringUtils.isBlank(student_id)  && StringUtils.isBlank(experiment_id)  && StringUtils.isBlank(curriculum_id)  && StringUtils.isBlank(subject_id)  && StringUtils.isBlank(user_id)  && StringUtils.isBlank(student_group_id) ) {
			...
			if (!StringUtils.isBlank(keyword)) {
				String kwss = keyword;
				queryWrapper.and(wr->wr.like(Vexperiment_record_mini.TRUENAME, kwss)
					.or().like(Vexperiment_record_mini.SNO, kwss)
					.or().like(Vexperiment_record_mini.SNO_EXP, kwss)
					.or().like(Vexperiment_record_mini.CLASSCODE, kwss)
					.or().like(Vexperiment_record_mini.STUDENT_GROUP_CODE, kwss)
					.or().like(Vexperiment_record_mini.STUDENT_GROUP_NAME, kwss)
					.or().like(Vexperiment_record_mini.SCORESCRIPT, kwss)
					.or().like(Vexperiment_record_mini.WECHAT_OPENID, kwss)
					.or().like(Vexperiment_record_mini.EXPERIMENT_TITLE, kwss)
					.or().like(Vexperiment_record_mini.SUBJECT_NAME, kwss)
						);
			}
			// 添加id使用in语句筛选
			if (!StringUtils.isBlank(student_id)) {
	 ...
	 * @return 是否成功 
	 */
	public Boolean updateVexperiment_record_miniById(Integer student_id,Integer experiment_id,Integer curriculum_id,String truename,String sno,String sno_exp,String classcode,Integer score,Boolean student_group_is_actived,Boolean student_is_actived,Boolean curriculum_is_actived,Boolean experiment_curriculum_is_actived,Boolean subject_is_actived,String student_group_code,String student_group_name,Long submit,String scorescript,Long update_gmt,String wechat_openid,String experiment_title,Boolean experiment_is_actived,String subject_name,Integer subject_id,Integer user_id,Long closing_gmt,Long opening_gmt,Integer curriculum_student_groupid,Integer student_group_id,Integer reviewstate,Integer experiment_curriculumid,Integer id) {
	...
	public Map<String, Integer> statVexperiment_record_miniGroupbyId() {
		...
		.select(Vexperiment_record_mini.TRUENAME, "count(*)")
		.eq(Vexperiment_record_mini.STUDENT_ID, 0)
		.groupBy(Vexperiment_record_mini.ID)
		.orderByAsc(Vexperiment_record_mini.ID)
		);
	 ...
	 * @return Vlink_experiment_curriculum列表 
	 */
	public List<Vlink_experiment_curriculum> listVlink_experiment_curriculumByMap(Map<String, Object> params, List<KeyAndValue> ordlist) {
	...
	public Vlink_experiment_curriculum getVlink_experiment_curriculumByExperiment_id(Serializable experiment_id) {
		...
		return svcvlink_experiment_curriculum.getOne(new QueryWrapper<Vlink_experiment_curriculum>().eq(Vlink_experiment_curriculum.EXPERIMENT_ID, experiment_id).last("limit 1"));
	}
	...
	public Vlink_experiment_curriculum getVlink_experiment_curriculumByMap(Map<String, Object> params) {
		...
		//Map<String, Object> params = new HashMap<String, Object>();
		//params.put(Vlink_experiment_curriculum.ID, 0);
		return svcvlink_experiment_curriculum.getOne(new QueryWrapper<Vlink_experiment_curriculum>().allEq(params).last("limit 1"));
	}
	...
	public List<Vlink_experiment_curriculum> listVlink_experiment_curriculumOrderByAsc(String columnname) {
		...
		return svcvlink_experiment_curriculum.list(new QueryWrapper<Vlink_experiment_curriculum>().orderByAsc(columnname));
	}
	...
	public List<Vlink_experiment_curriculum> listVlink_experiment_curriculumOrderByDesc(String columnname) {
		...
		return svcvlink_experiment_curriculum.list(new QueryWrapper<Vlink_experiment_curriculum>().orderByDesc(columnname));
	}
	 ...
	 * @return Vlink_experiment_curriculum列表 
	 */
	public List<Vlink_experiment_curriculum> listVlink_experiment_curriculumByMapAsc(Map<String, Object> params,String columnname) {

		logger.debug(this.getClass().getName() + ".listVlink_experiment_curriculumByMapAsc()");
		return svcvlink_experiment_curriculum.list(new QueryWrapper<Vlink_experiment_curriculum>().allEq(params).orderByAsc(columnname));
	}
	 ...
	 * @return Vlink_experiment_curriculum列表 
	 */
	public List<Vlink_experiment_curriculum> listVlink_experiment_curriculumByMapDesc(Map<String, Object> params,String columnname) {

		logger.debug(this.getClass().getName() + ".listVlink_experiment_curriculumByMapDesc()");
		return svcvlink_experiment_curriculum.list(new QueryWrapper<Vlink_experiment_curriculum>().allEq(params).orderByDesc(columnname));
	}
	 ...
	 * @return
	 */
	public PagerList<Vlink_experiment_curriculum> pagerListVlink_experiment_curriculum(Integer pagenumber, Integer pagesize) {
	 ...
	 * @return
	 */
	public PagerList<Vlink_experiment_curriculum> pagerListVlink_experiment_curriculum(Integer pagenumber, Integer pagesize, String keyword) {
	 ...
	 * @return
	 */
	public PagerList<Vlink_experiment_curriculum> pagerListVlink_experiment_curriculum(Integer pagenumber, Integer pagesize, String keyword, Map<String, String> sqlin) {
		return pagerListVlink_experiment_curriculum(pagenumber, pagesize, keyword, sqlin, new HashMap<String, Object>());
	}
	/***
	 * 
	 * @param pagenumber	页码
	 ...
	 * @return
	 */
	public PagerList<Vlink_experiment_curriculum> pagerListVlink_experiment_curriculum(Integer pagenumber, Integer pagesize, String keyword, Map<String, String> sqlin, Map<String, Object> params) {
		List<KeyAndValue> ordlist=new ArrayList<KeyAndValue>();
		ordlist.add(new KeyAndValue(Vlink_experiment_curriculum.ID,  "desc"));
	 ...
	 * @return
	 */
	public PagerList<Vlink_experiment_curriculum> pagerListVlink_experiment_curriculum(Integer pagenumber, Integer pagesize, String keyword, Map<String, String> sqlin, Map<String, Object> params, List<KeyAndValue> ordlist) {
		...
		if (StringUtils.isBlank(keyword) && StringUtils.isBlank(experiment_id)  && StringUtils.isBlank(curriculum_id)  && StringUtils.isBlank(subject_id)  && StringUtils.isBlank(student_group_id)  && StringUtils.isBlank(user_id) ) {
			...
			if (!StringUtils.isBlank(keyword)) {
				String kwss = keyword;
				queryWrapper.and(wr->wr.like(Vlink_experiment_curriculum.EXPERIMENT_CONTENT, kwss)
					.or().like(Vlink_experiment_curriculum.EXPERIMENT_INTRO, kwss)
					.or().like(Vlink_experiment_curriculum.EXPERIMENT_TITLE, kwss)
					.or().like(Vlink_experiment_curriculum.PURPOSES_REQUIREMENT, kwss)
					.or().like(Vlink_experiment_curriculum.SEMESTER, kwss)
					.or().like(Vlink_experiment_curriculum.STUDENT_GROUP_NAME, kwss)
					.or().like(Vlink_experiment_curriculum.SUBJECT_INTRO, kwss)
					.or().like(Vlink_experiment_curriculum.SUBJECT_NAME, kwss)
					.or().like(Vlink_experiment_curriculum.SUBJECT_ILLUSTRATION, kwss)
						);
			}
			// 添加id使用in语句筛选
			if (!StringUtils.isBlank(experiment_id)) {
		...
		for (int i = 0; i < list.size(); i++) {
			...
			if (!StringUtils.isBlank(keyword)) {
				...
				try {
					...
					list.get(i).setExperiment_content((list.get(i).getExperiment_content().replace(keyword, Common.getKeywordSpan(keyword))));
					list.get(i).setExperiment_intro((list.get(i).getExperiment_intro().replace(keyword, Common.getKeywordSpan(keyword))));
					list.get(i).setExperiment_title((list.get(i).getExperiment_title().replace(keyword, Common.getKeywordSpan(keyword))));
					list.get(i).setPurposes_requirement((list.get(i).getPurposes_requirement().replace(keyword, Common.getKeywordSpan(keyword))));
					list.get(i).setSemester((list.get(i).getSemester().replace(keyword, Common.getKeywordSpan(keyword))));
					list.get(i).setStudent_group_name((list.get(i).getStudent_group_name().replace(keyword, Common.getKeywordSpan(keyword))));
					list.get(i).setSubject_intro((list.get(i).getSubject_intro().replace(keyword, Common.getKeywordSpan(keyword))));
					list.get(i).setSubject_name((list.get(i).getSubject_name().replace(keyword, Common.getKeywordSpan(keyword))));
					list.get(i).setSubject_illustration((list.get(i).getSubject_illustration().replace(keyword, Common.getKeywordSpan(keyword))));
				} catch (Exception e) {
				    e.printStackTrace();
				}
			}
	...
	public Boolean moveVlink_experiment_curriculum(String method, String upOrDown, Integer id, String sortColumn) {
		...
		QueryWrapper<Vlink_experiment_curriculum> queryWrapper = new QueryWrapper<>();
		// 同一个父栏目下
		// queryWrapper.eq(Vlink_experiment_curriculum.COLUMN_PARENTID , it.getColumn_parentid());
		if (method.equals(upOrDown)) {
			queryWrapper.lt(sortColumn, it.getSortid());
			queryWrapper.orderByDesc(sortColumn);
		} else {
	...
	public Map<String, Integer> statVlink_experiment_curriculumGroupbyId() {
		List<Map<String, Object>> list = svcvlink_experiment_curriculum.listMaps(new QueryWrapper<Vlink_experiment_curriculum>()
		.select(Vlink_experiment_curriculum.EXPERIMENT_CONTENT, "count(*)")
		.eq(Vlink_experiment_curriculum.EXPERIMENT_ID, 0)
		.groupBy(Vlink_experiment_curriculum.ID)
	 ...
	 * @return Vlink_experiment_curriculum_min列表 
	 */
	public List<Vlink_experiment_curriculum_min> listVlink_experiment_curriculum_minByMap(Map<String, Object> params, List<KeyAndValue> ordlist) {
	 ...
	 * @return Vlink_experiment_curriculum_min 
	 */
	public Vlink_experiment_curriculum_min getVlink_experiment_curriculum_minByExperiment_id(Serializable experiment_id) {

		logger.debug(this.getClass().getName() + ".getVlink_experiment_curriculum_minByExperiment_id()");
		return svcvlink_experiment_curriculum_min.getOne(new QueryWrapper<Vlink_experiment_curriculum_min>().eq(Vlink_experiment_curriculum_min.EXPERIMENT_ID, experiment_id).last("limit 1"));
	}
	...
	public Vlink_experiment_curriculum_min getVlink_experiment_curriculum_minByMap(Map<String, Object> params) {
		...
		//Map<String, Object> params = new HashMap<String, Object>();
		//params.put(Vlink_experiment_curriculum_min.ID, 0);
		return svcvlink_experiment_curriculum_min.getOne(new QueryWrapper<Vlink_experiment_curriculum_min>().allEq(params).last("limit 1"));
	}
	...
	public List<Vlink_experiment_curriculum_min> listVlink_experiment_curriculum_minOrderByAsc(String columnname) {
		...
		return svcvlink_experiment_curriculum_min.list(new QueryWrapper<Vlink_experiment_curriculum_min>().orderByAsc(columnname));
	}
	...
	public List<Vlink_experiment_curriculum_min> listVlink_experiment_curriculum_minOrderByDesc(String columnname) {
		...
		return svcvlink_experiment_curriculum_min.list(new QueryWrapper<Vlink_experiment_curriculum_min>().orderByDesc(columnname));
	}
	 ...
	 * @return Vlink_experiment_curriculum_min列表 
	 */
	public List<Vlink_experiment_curriculum_min> listVlink_experiment_curriculum_minByMapAsc(Map<String, Object> params,String columnname) {

		logger.debug(this.getClass().getName() + ".listVlink_experiment_curriculum_minByMapAsc()");
		return svcvlink_experiment_curriculum_min.list(new QueryWrapper<Vlink_experiment_curriculum_min>().allEq(params).orderByAsc(columnname));
	}
	 ...
	 * @return Vlink_experiment_curriculum_min列表 
	 */
	public List<Vlink_experiment_curriculum_min> listVlink_experiment_curriculum_minByMapDesc(Map<String, Object> params,String columnname) {

		logger.debug(this.getClass().getName() + ".listVlink_experiment_curriculum_minByMapDesc()");
		return svcvlink_experiment_curriculum_min.list(new QueryWrapper<Vlink_experiment_curriculum_min>().allEq(params).orderByDesc(columnname));
	}
	 ...
	 * @return
	 */
	public PagerList<Vlink_experiment_curriculum_min> pagerListVlink_experiment_curriculum_min(Integer pagenumber, Integer pagesize) {
	 ...
	 * @return
	 */
	public PagerList<Vlink_experiment_curriculum_min> pagerListVlink_experiment_curriculum_min(Integer pagenumber, Integer pagesize, String keyword) {
	 ...
	 * @return
	 */
	public PagerList<Vlink_experiment_curriculum_min> pagerListVlink_experiment_curriculum_min(Integer pagenumber, Integer pagesize, String keyword, Map<String, String> sqlin) {
		return pagerListVlink_experiment_curriculum_min(pagenumber, pagesize, keyword, sqlin, new HashMap<String, Object>());
	}
	/***
	 * 
	 * @param pagenumber	页码
	 ...
	 * @return
	 */
	public PagerList<Vlink_experiment_curriculum_min> pagerListVlink_experiment_curriculum_min(Integer pagenumber, Integer pagesize, String keyword, Map<String, String> sqlin, Map<String, Object> params) {
		List<KeyAndValue> ordlist=new ArrayList<KeyAndValue>();
		ordlist.add(new KeyAndValue(Vlink_experiment_curriculum_min.ID,  "desc"));
	 ...
	 * @return
	 */
	public PagerList<Vlink_experiment_curriculum_min> pagerListVlink_experiment_curriculum_min(Integer pagenumber, Integer pagesize, String keyword, Map<String, String> sqlin, Map<String, Object> params, List<KeyAndValue> ordlist) {
		...
		if (StringUtils.isBlank(keyword) && StringUtils.isBlank(experiment_id)  && StringUtils.isBlank(curriculum_id)  && StringUtils.isBlank(subject_id)  && StringUtils.isBlank(student_group_id)  && StringUtils.isBlank(user_id) ) {
			...
			if (!StringUtils.isBlank(keyword)) {
				String kwss = keyword;
				queryWrapper.and(wr->wr.like(Vlink_experiment_curriculum_min.EXPERIMENT_TITLE, kwss)
					.or().like(Vlink_experiment_curriculum_min.SEMESTER, kwss)
					.or().like(Vlink_experiment_curriculum_min.STUDENT_GROUP_NAME, kwss)
					.or().like(Vlink_experiment_curriculum_min.SUBJECT_INTRO, kwss)
					.or().like(Vlink_experiment_curriculum_min.SUBJECT_NAME, kwss)
					.or().like(Vlink_experiment_curriculum_min.SUBJECT_ILLUSTRATION, kwss)
						);
			}
			// 添加id使用in语句筛选
			if (!StringUtils.isBlank(experiment_id)) {
	 ...
	 * @return 是否成功 
	 */
	public Boolean updateVlink_experiment_curriculum_minById(Integer experiment_id,Integer curriculum_id,Integer subject_id,Long opening_gmt,Long closing_gmt,Integer sortid,Boolean experiment_curriculum_is_actived,String experiment_title,Integer filesize,Integer student_group_id,Integer user_id,String semester,String student_group_name,Boolean subject_is_actived,String subject_intro,String subject_name,String subject_illustration,Boolean curriculum_is_actived,Integer subject_sortid,Integer id) {
	...
	public Boolean moveVlink_experiment_curriculum_min(String method, String upOrDown, Integer id, String sortColumn) {
		...
		QueryWrapper<Vlink_experiment_curriculum_min> queryWrapper = new QueryWrapper<>();
		// 同一个父栏目下
		// queryWrapper.eq(Vlink_experiment_curriculum_min.COLUMN_PARENTID , it.getColumn_parentid());
		if (method.equals(upOrDown)) {
			queryWrapper.lt(sortColumn, it.getSortid());
			queryWrapper.orderByDesc(sortColumn);
		} else {
	...
	public Map<String, Integer> statVlink_experiment_curriculum_minGroupbyId() {
		List<Map<String, Object>> list = svcvlink_experiment_curriculum_min.listMaps(new QueryWrapper<Vlink_experiment_curriculum_min>()
		.select(Vlink_experiment_curriculum_min.EXPERIMENT_TITLE, "count(*)")
		.eq(Vlink_experiment_curriculum_min.EXPERIMENT_ID, 0)
		.groupBy(Vlink_experiment_curriculum_min.ID)
		.orderByAsc(Vlink_experiment_curriculum_min.ID)
		);
	 ...
	 * @return Vlink_student2group列表 
	 */
	public List<Vlink_student2group> listVlink_student2groupByMap(Map<String, Object> params, List<KeyAndValue> ordlist) {
	...
	public Vlink_student2group getVlink_student2groupByStudent_id(Serializable student_id) {
		...
		return svcvlink_student2group.getOne(new QueryWrapper<Vlink_student2group>().eq(Vlink_student2group.STUDENT_ID, student_id).last("limit 1"));
	}
	...
	public List<Vlink_student2group> listVlink_student2groupByMapAsc(Map<String, Object> params,String columnname) {
		...
		return svcvlink_student2group.list(new QueryWrapper<Vlink_student2group>().allEq(params).orderByAsc(columnname));
	}
	...
	public List<Vlink_student2group> listVlink_student2groupByMapDesc(Map<String, Object> params,String columnname) {
		...
		return svcvlink_student2group.list(new QueryWrapper<Vlink_student2group>().allEq(params).orderByDesc(columnname));
	}
	 ...
	 * @return
	 */
	public PagerList<Vlink_student2group> pagerListVlink_student2group(Integer pagenumber, Integer pagesize, String keyword) {
	 ...
	 * @return
	 */
	public PagerList<Vlink_student2group> pagerListVlink_student2group(Integer pagenumber, Integer pagesize, String keyword, Map<String, String> sqlin) {
	 ...
	 * @return
	 */
	public PagerList<Vlink_student2group> pagerListVlink_student2group(Integer pagenumber, Integer pagesize, String keyword, Map<String, String> sqlin, Map<String, Object> params) {
		List<KeyAndValue> ordlist=new ArrayList<KeyAndValue>();
		ordlist.add(new KeyAndValue(Vlink_student2group.ID,  "desc"));
	 ...
	 * @return
	 */
	public PagerList<Vlink_student2group> pagerListVlink_student2group(Integer pagenumber, Integer pagesize, String keyword, Map<String, String> sqlin, Map<String, Object> params, List<KeyAndValue> ordlist) {
		...
		if (StringUtils.isBlank(keyword) && StringUtils.isBlank(student_id)  && StringUtils.isBlank(student_group_id) ) {
			...
			if (!StringUtils.isBlank(keyword)) {
				String kwss = keyword;
				queryWrapper.and(wr->wr.like(Vlink_student2group.SNO, kwss)
					.or().like(Vlink_student2group.NAME, kwss)
					.or().like(Vlink_student2group.EMAIL, kwss)
					.or().like(Vlink_student2group.MOBILE, kwss)
					.or().like(Vlink_student2group.QQ, kwss)
					.or().like(Vlink_student2group.CLASSCODE, kwss)
					.or().like(Vlink_student2group.STUDENT_GROUP_NAME, kwss)
					.or().like(Vlink_student2group.STUDENT_GROUP_CODE, kwss)
						);
			}
			// 添加id使用in语句筛选
			if (!StringUtils.isBlank(student_id)) {
	 ...
	 * @return 是否成功 
	 */
	public Boolean updateVlink_student2groupById(Integer student_id,Integer student_group_id,Boolean student_is_actived,Boolean student_group_is_actived,String sno,String name,String email,String mobile,String qq,String classcode,Integer login_method,String student_group_name,String student_group_code,Integer id) {
	...
	public Map<String, Integer> statVlink_student2groupGroupbyId() {
		...
		.select(Vlink_student2group.SNO, "count(*)")
		.eq(Vlink_student2group.STUDENT_ID, 0)
		.groupBy(Vlink_student2group.ID)
		.orderByAsc(Vlink_student2group.ID)
		);
