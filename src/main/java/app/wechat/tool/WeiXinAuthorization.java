 ...
 * 
 * @author 昊琦
 * @version 1.0 @创建时间：2018年3月14日20:38:42
 */
public class WeiXinAuthorization {
	...
	public static Oauth2AccessToken getOauth2AccessToken(String appId, String appSecret, String code) {
		...
		if (jsonObject.containsKey("errcode")) {
			...
			// 如果请求后接收到的数据符合要求
			Oauth2AccessToken oauth2AccessToken = (Oauth2AccessToken) JSONObject.toBean(jsonObject,
	...
	public static SnsUserInfo getSnsUserInfo(String accessToken, String openId) {
		...
		// System.out.println("WeiXinAuthorization.getSnsUserInfo()snsapi_userinfo_url="+snsapi_userinfo_url);
		// 发送http请求
		JSONObject jsonObject = HttpRequest.sendGet(snsapi_userinfo_url);
