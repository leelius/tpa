...
<body>
		...
		<div>
			...
			<ul class="nav nav-tabs" role="tablist">
				<li role="presentation"
					<c:if test="${canusewechat}">class="active"</c:if>>
					<a href="#wechat" aria-controls="wechat" role="tab" data-toggle="tab">微信登录</a></li>
				<li role="presentation"
					<c:if test="${canusewechat==false}">class="active"</c:if>>
					<a href="#login" aria-controls="login" role="tab" data-toggle="tab">密码登录</a></li>
			</ul>
			<!-- Tab panes -->
			...
			<div class="tab-content">
				...
				<div role="tabpanel"
					...
					<form class="form-horizontal " method="post" action="${basePath}${action}" style="min-height: 300px;">
						<input type="hidden" name="operate" value="register"> <br>
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								<input type="password" class="form-control" id="password2"
									   autocomplete="off" name="password2" placeholder="确认密码" value="">
								<%--  --%>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-8">
								<div class="input-group">
									<span title="图片看不清时点击更新验证码" class="input-group-addon padding-0"
										...
										src="${basePath}/getverificationcodeimage"></span>
									<input type="text" class="form-control" id=vcodeinput
						...
						<div class="form-group">
							<div class="col-sm-offset-2 col-sm-8">
								<button type="submit" class="btn btn-primary col-xs-12">注册</button>
							</div>
						</div>
					</form>
				</div>
	...
	<div class="text-center">
		<p>2014-2019.${appName} 版权所有 All rights reserved.</p>
	</div>
	<%-- 
