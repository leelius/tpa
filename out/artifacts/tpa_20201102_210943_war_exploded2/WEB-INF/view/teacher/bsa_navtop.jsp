	...
	<ul class="nav navbar-top-links navbar-right">
		<li class="dropdown"><a class="dropdown-toggle"
			data-toggle="dropdown" href="#" aria-expanded="false"><i
				class="fa fa-user fa-fw"></i><span class="text-primary">${user.real_name}</span>
				<i class="fa fa-caret-down"></i> </a>
			<ul class="dropdown-menu dropdown-user">
				<li><a href="teacher/userinfo"><i class="fa fa-user fa-fw"></i>个人信息</a></li>
				<li><a href="teacher/userpassword"><i class="fa fa-gear fa-fw"></i> 修改密码</a></li>
