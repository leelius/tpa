						...
						<div class="panel panel-default">
							...
							<div class="row margin-xs">
								<div class="col-xs-12 col-sm-12 col-md-1 col-lg-1">
										<div><a href="${pagename}?operate=add" class="btn btn-primary">新增</a></div>
								</div>
		...
		<div class="row">
			<div class="col-sm-12">
				<button class="btn btn-success" type="button"
					...
					筛选条件</button>
				<div id="searchPanel"
					<c:if test="${kw != null  || experiment_id_map != null  || curriculum_id_map != null  || subject_id_map != null  || student_group_id_map != null  || student_id_map != null }">class="collapse in form-inline" </c:if>
					<c:if test="${kw == null  && experiment_id_map == null  && curriculum_id_map == null  && subject_id_map == null  && student_group_id_map == null  && student_id_map == null }">class="collapse form-inline" </c:if>>
					<div class="well">
						<!-- 面板 -->
						<div class="row">
							<div
												...
												<tbody>
													<c:forEach var="it" items="${list}" varStatus="index">
														<tr>
															...
															<td>${it.name}</td>
															<td>
<button value="${it.id}" class="moveup btn btn-sm btn-info" <c:if test="${index.count==1}">disabled</c:if>>上移</button>
<button value="${it.id}" class="movedown btn btn-sm btn-warning" <c:if test="${index.count==pager.total}">disabled</c:if>>下移</button>
	...
	<c:forEach var="it" items="${list}" varStatus="index">
		<div class="col-xs-12 col-sm-6">
			<div class="row showbd margin-xs">
				<div class="col-xs-12 col-sm-12 bg-primary padding-xs" id="t${it.id}"><h3>${index.count+(pager.current - 1) * pager.size}</h3></div>
				<div class="clearfix"></div>
...
<button value="${it.id}" class="movedown btn btn-warning" <c:if test="${index.count==pager.total}">disabled</c:if>>下移</button>
...
<!-- selectbox begin -->
<div class="form-group">
	<label for="experiment_id" class="col-sm-2 control-label"></label>
	<div class="col-sm-10">
...
<!-- selectbox begin -->
<div class="form-group">
	<label for="curriculum_id" class="col-sm-2 control-label"></label>
	<div class="col-sm-10">
...
<!-- selectbox begin -->
<div class="form-group">
	<label for="subject_id" class="col-sm-2 control-label"></label>
	<div class="col-sm-10">
...
<div class="form-group d_t_dater">
	<label for="opening_gmt_date" class="col-sm-2 control-label"></label>
	<div class="col-sm-10">
...
<div class="form-group d_t_dater">
	<label for="closing_gmt_date" class="col-sm-2 control-label"></label>
	<div class="col-sm-10">
		<div class="input-group">
	<span class="input-group-addon" style="cursor: pointer;"
...
<div class="form-group">
	<label for="sortid" class="col-sm-2 control-label"></label>
	<div class="col-sm-10">
