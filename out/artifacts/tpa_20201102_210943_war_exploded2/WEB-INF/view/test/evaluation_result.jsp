...
<c:if test="${searchpanel=='true'}">
	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
		<div class="row">
			<div class="col-sm-12">
				<div id="searchPanel"
					<c:if test="${kw != null  || student_id_map != null  || evaluation_id_map != null }">class="collapse in form-inline" </c:if>
					<c:if test="${kw == null  && student_id_map == null  && evaluation_id_map == null }">class="collapse form-inline" </c:if>>
					<div class="well">
						<!-- 面板 -->
						<div class="row">
							<div
												...
												<tbody>
													<c:forEach var="it" items="${list}" varStatus="index">
														<tr>
															...
															<td>${it.sno}</td>
															<td>${it.comment}</td>
															<td>${it.evaluation_record}</td>
															<td>${it.score}</td>
															<td><c:if test="${it.submit_gmt !=0}"><fmt:formatDate pattern="yyyy-MM-dd" value="${it.submit_gmt_date}" /></c:if></td>
															<td>
	<c:choose>
...
<div class="row">
	<c:forEach var="it" items="${list}" varStatus="index">
		<div class="col-xs-12 col-sm-6">
			...
			<div class="col-xs-12 col-sm-12">${it.evaluation_record}</div>
				<div class="clearfix"></div>

			<div class="col-xs-12 col-sm-12">${it.score}</div>
				<div class="clearfix"></div>

			<div class="col-xs-12 col-sm-12"><c:if test="${it.submit_gmt !=0}"><fmt:formatDate pattern="yyyy-MM-dd" value="${it.submit_gmt_date}" /></c:if></div>
				<div class="clearfix"></div>
...
<div class="form-group">
	<label for="comment" class="col-sm-3 control-label">评阅注释</label>
	<div class="col-sm-9">
		<input type="text" class="form-control" id="comment"
			name="comment" placeholder="评阅注释">
	</div>
</div>
<div class="form-group">
	<label for="evaluation_record" class="col-sm-3 control-label"></label>
	<div class="col-sm-9">
<textarea class="form-control" id="evaluation_record" name="evaluation_record" style="width:100%;height:400px;visibility:hidden;"></textarea>
	</div>
</div>
<div class="form-group">
	<label for="score" class="col-sm-3 control-label">考核成绩</label>
	<div class="col-sm-9">
		<input type="text" class="form-control restrictnumber" id="score"
			name="score" placeholder="考核成绩" >
	</div>
</div>
<div class="form-group d_t_dater">
	<label for="submit_gmt_date" class="col-sm-3 control-label">提交日期</label>
	<div class="col-sm-9">
		<div class="input-group">
	<span class="input-group-addon" style="cursor: pointer;"
	onclick="$.jeDate('#submit_gmt_date',{trigger:false,format: 'YYYY-MM-DD hh:mm:ss'})">提交日期</span>
<input placeholder="提交日期" type="text"
	class="form-control" id="submit_gmt_date"
	name="submit_gmt_date" readonly>
		</div>
	</div>
</div>
<div class="form-group">
	<label for="is_reviewed" class="col-sm-3 control-label">评阅完成</label>
	<div class="col-sm-9">
		<div
			class="checkbox3 checkbox-round checkbox-check checkbox-light">
					<input type="checkbox" id="is_reviewed" name="is_reviewed">
			<label for="is_reviewed"> 评阅完成 </label>
		</div>
	</div>
</div>
<div class="form-group d_t_dater">
...
<div class="form-group">
	...
	<div class="col-sm-9">
		<input type="text" class="form-control" id="comment"
			name="comment" placeholder="评阅注释" value="${it.comment}">
	</div>
</div>
<div class="form-group">
	<label for="evaluation_record" class="col-sm-3 control-label"></label>
	<div class="col-sm-9">
<textarea class="form-control" id="evaluation_record" name="evaluation_record" style="width:100%;height:400px;visibility:hidden;">${it.evaluation_record}</textarea>
	</div>
</div>
<div class="form-group">
	<label for="score" class="col-sm-3 control-label">考核成绩</label>
	<div class="col-sm-9">
		<input type="text" class="form-control restrictnumber" id="score"
			name="score" placeholder="考核成绩" value="${it.score}">
	</div>
</div>
<div class="form-group d_t_dater">
	<label for="submit_gmt_date" class="col-sm-3 control-label">提交日期</label>
...
<input placeholder="提交日期" type="text"
	class="form-control" id="submit_gmt_date"
	name="submit_gmt_date"
	<c:if test="${it.submit_gmt != 0}">
	value="<fmt:formatDate pattern='yyyy-MM-dd HH:mm:ss' value='${it.submit_gmt_date}' />"
	</c:if>
	readonly>
		</div>
	</div>
		...
		<script type="text/javascript">
			$(document).ready(function() {
				...
				$("#form1").submit(function(e) {
					...
					if ($("#evaluation_record").val() == '') {
						alert("必须输入！");
						$("#evaluation_record").focus();
						return false;
					}
					if ($("#score").val() == '') {
						alert("考核成绩必须输入！");
					...
					if ($("#submit_gmt_date").val() == '') {
						alert("提交日期必须输入！");
						$("#submit_gmt_date").focus();
						return false;
					}
					if ($("#is_reviewed").val() == '') {
						alert("评阅完成必须输入！");
...
KindEditor.ready(function(K) {
	var editor1 = K.create('textarea[name="evaluation_record"]', {
