...
<div class="form-group">
	<label for="is_actived" class="col-sm-3 control-label">是否可以登录</label>
	<div class="col-sm-9">
		<div
...
<div class="form-group">
	<label for="code" class="col-sm-3 control-label">分组编号，8位字符</label>
	<div class="col-sm-9">
...
<div class="form-group">
	<label for="name" class="col-sm-3 control-label">组名</label>
	<div class="col-sm-9">
