...
<div class="form-group">
	<label for="target" class="col-sm-3 control-label">许可表名:user</label>
	<div class="col-sm-9">
		<input type="text" class="form-control" id="target"
			name="target" placeholder="许可表名:user">
	</div>
</div>
<div class="form-group">
	<label for="operation" class="col-sm-3 control-label">许可操作:insert</label>
	<div class="col-sm-9">
		<input type="text" class="form-control" id="operation"
			name="operation" placeholder="许可操作:insert">
	</div>
</div>
<div class="form-group">
	<label for="name" class="col-sm-3 control-label">许可名称:更新用户</label>
	<div class="col-sm-9">
		<input type="text" class="form-control" id="name"
			name="name" placeholder="许可名称:更新用户">
	</div>
</div>
<div class="form-group">
	<label for="code" class="col-sm-3 control-label">许可代码(user:insert)库名:操作</label>
	<div class="col-sm-9">
		<input type="text" class="form-control" id="code"
			name="code" placeholder="许可代码(user:insert)库名:操作">
	</div>
</div>
<div class="form-group">
...
<div class="form-group">
	...
	<div class="col-sm-9">
		<input type="text" class="form-control" id="target"
			name="target" placeholder="许可表名:user" value="${it.target}">
	</div>
</div>
<div class="form-group">
	<label for="operation" class="col-sm-3 control-label">许可操作:insert</label>
	<div class="col-sm-9">
		<input type="text" class="form-control" id="operation"
			name="operation" placeholder="许可操作:insert" value="${it.operation}">
	</div>
</div>
<div class="form-group">
	<label for="name" class="col-sm-3 control-label">许可名称:更新用户</label>
	<div class="col-sm-9">
		<input type="text" class="form-control" id="name"
			name="name" placeholder="许可名称:更新用户" value="${it.name}">
	</div>
</div>
<div class="form-group">
	<label for="code" class="col-sm-3 control-label">许可代码(user:insert)库名:操作</label>
	<div class="col-sm-9">
		<input type="text" class="form-control" id="code"
			name="code" placeholder="许可代码(user:insert)库名:操作" value="${it.code}">
	</div>
</div>
<div class="form-group">
	<label for="create_userid" class="col-sm-3 control-label">创建者</label>
