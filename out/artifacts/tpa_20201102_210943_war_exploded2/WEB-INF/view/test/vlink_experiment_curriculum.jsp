	...
	<c:choose>
		...
		<c:when test="${it.experiment_curriculum_is_actived==false}">
			<a href="${basePath}${pagename}?operate=showitem&id=${it.id}" ><img alt="" src="bssets/i/reddot.png"></a>
															...
															<td>${it.experiment_intro}</td>
															<td>${it.experiment_title}</td>
															<td>
	<c:choose>
		<c:when test="${it.experiment_is_actived}">
			<a href="${basePath}${pagename}?operate=hideitem&id=${it.id}" ><img alt="" src="bssets/i/greendot.png"></a>
		</c:when>
		<c:when test="${it.experiment_is_actived==false}">
			<a href="${basePath}${pagename}?operate=showitem&id=${it.id}" ><img alt="" src="bssets/i/reddot.png"></a>
		</c:when>
	</c:choose>
</td>
															<td>${it.purposes_requirement}</td>
															<td>${it.filesize}</td>
...
<div class="row">
	<c:forEach var="it" items="${list}" varStatus="index">
		<div class="col-xs-12 col-sm-6">
			...
			<div class="col-xs-12 col-sm-12">${it.experiment_intro}</div>
				<div class="clearfix"></div>

			<div class="col-xs-12 col-sm-12">${it.experiment_title}</div>
				<div class="clearfix"></div>

			<div class="col-xs-12 col-sm-12">${it.experiment_is_actived}</div>
				<div class="clearfix"></div>

			<div class="col-xs-12 col-sm-12">${it.purposes_requirement}</div>
				<div class="clearfix"></div>
...
<div class="form-group">
	<label for="experiment_intro" class="col-sm-3 control-label"></label>
	<div class="col-sm-9">
		<input type="text" class="form-control" id="experiment_intro"
			name="experiment_intro" placeholder="">
	</div>
</div>
<div class="form-group">
...
<div class="form-group">
	<label for="experiment_is_actived" class="col-sm-3 control-label">是否可用</label>
	<div class="col-sm-9">
		<div
			class="checkbox3 checkbox-round checkbox-check checkbox-light">
					<input type="checkbox" id="experiment_is_actived" name="experiment_is_actived">
			<label for="experiment_is_actived"> 是否可用 </label>
		</div>
	</div>
</div>
<div class="form-group">
	<label for="purposes_requirement" class="col-sm-3 control-label">实验目的及要求</label>
	<div class="col-sm-9">
<textarea class="form-control" id="purposes_requirement" name="purposes_requirement" style="width:100%;height:400px;visibility:hidden;"></textarea>
	</div>
</div>
<div class="form-group">
...
<div class="form-group">
	...
	<div class="col-sm-9">
		<input type="text" class="form-control" id="experiment_intro"
			name="experiment_intro" placeholder="" value="${it.experiment_intro}">
	</div>
</div>
<div class="form-group">
	<label for="experiment_title" class="col-sm-3 control-label">实验标题</label>
...
<div class="form-group">
	...
	<div class="col-sm-9">
		<div
			class="checkbox3 checkbox-round checkbox-check checkbox-light">
			<c:choose>
				<c:when test="${it.experiment_is_actived == true}">
					<input type="checkbox" id="experiment_is_actived" name="experiment_is_actived"
						checked>
				</c:when>
				<c:when test="${it.experiment_is_actived == false}">
...
<div class="form-group">
	<label for="purposes_requirement" class="col-sm-3 control-label">实验目的及要求</label>
	<div class="col-sm-9">
<textarea class="form-control" id="purposes_requirement" name="purposes_requirement" style="width:100%;height:400px;visibility:hidden;">${it.purposes_requirement}</textarea>
	</div>
</div>
<div class="form-group">
	<label for="filesize" class="col-sm-3 control-label">文件大小</label>
		...
		<script type="text/javascript">
			$(document).ready(function() {
				...
				$("#form1").submit(function(e) {
					...
					if ($("#experiment_intro").val() == '') {
						alert("必须输入！");
						$("#experiment_intro").focus();
						return false;
					}
					...
					if ($("#experiment_is_actived").val() == '') {
						alert("是否可用必须输入！");
						$("#experiment_is_actived").focus();
						return false;
					}
					if ($("#purposes_requirement").val() == '') {
						alert("实验目的及要求必须输入！");
						$("#purposes_requirement").focus();
						return false;
					}
					if ($("#filesize").val() == '') {
						alert("文件大小必须输入！");
...
KindEditor.ready(function(K) {
	...
	var editor1 = K.create('textarea[name="purposes_requirement"]', {
		cssPath : '${basePath}bssets/ket/plugins/code/prettify.css',
		uploadJson : '${basePath}admin/uploadfile',
		fileManagerJson : '${basePath}admin/filemanager',
		allowFileManager : true,
