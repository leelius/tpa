...
<div class="row">
	<c:forEach var="it" items="${list}" varStatus="index">
		<div class="col-xs-12 col-sm-6">
			...
			<div class="col-xs-12 col-sm-12">${it.st_date}</div>
				<div class="clearfix"></div>

			<div class="col-xs-12 col-sm-12">${it.st_total}</div>
				<div class="clearfix"></div>

			<div class="col-xs-12 col-sm-12">${it.st_today}</div>
				<div class="clearfix"></div>
...
<div class="form-group">
	<label for="st_date" class="col-sm-3 control-label"></label>
	<div class="col-sm-9">
		<input type="text" class="form-control" id="st_date"
			name="st_date" placeholder="">
	</div>
</div>
<div class="form-group">
	<label for="st_total" class="col-sm-3 control-label"></label>
	<div class="col-sm-9">
		<input type="text" class="form-control restrictnumber" id="st_total"
			name="st_total" placeholder="" >
	</div>
</div>
<div class="form-group">
	<label for="st_today" class="col-sm-3 control-label"></label>
	<div class="col-sm-9">
		<input type="text" class="form-control restrictnumber" id="st_today"
			name="st_today" placeholder="" >
	</div>
</div>
<div class="form-group">
...
<div class="form-group">
	...
	<div class="col-sm-9">
		<input type="text" class="form-control" id="st_date"
			name="st_date" placeholder="" value="${it.st_date}">
	</div>
</div>
<div class="form-group">
	<label for="st_total" class="col-sm-3 control-label"></label>
	<div class="col-sm-9">
		<input type="text" class="form-control restrictnumber" id="st_total"
			name="st_total" placeholder="" value="${it.st_total}">
	</div>
</div>
<div class="form-group">
	<label for="st_today" class="col-sm-3 control-label"></label>
	<div class="col-sm-9">
		<input type="text" class="form-control restrictnumber" id="st_today"
			name="st_today" placeholder="" value="${it.st_today}">
	</div>
</div>
<div class="form-group">
	<div class="col-sm-offset-3 col-sm-9">
