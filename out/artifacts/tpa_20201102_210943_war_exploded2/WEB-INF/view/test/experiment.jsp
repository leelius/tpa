...
<c:if test="${searchpanel=='true'}">
	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
		<div class="row">
			<div class="col-sm-12">
				<div id="searchPanel"
					<c:if test="${kw != null  || subject_id_map != null  || curriculum_id_map != null }">class="collapse in form-inline" </c:if>
					<c:if test="${kw == null  && subject_id_map == null  && curriculum_id_map == null }">class="collapse form-inline" </c:if>>
					<div class="well">
						<!-- 面板 -->
						<div class="row">
							<div
...
<!-- radio end -->
						...
						<div class="clearfix showborder-top"></div>
						<!-- /搜索条件： -->
						<!-- 搜索条件：课程id，如果未指定课程，即为该科目共有实验 -->
						<div class="row">
							<div class="col-xs-4 col-sm-3 col-md-2 col-lg-2 text-right margin-top-xs">
								课程，如果未指定课程，即为该科目共有实验:</div>
...
<!-- selectbox begin -->
<div class="form-group">
	<label for="curriculum_id" class="col-sm-3 control-label">课程id，如果未指定课程，即为该科目共有实验</label>
	<div class="col-sm-9">
...
<div class="form-group">
	<label for="intro" class="col-sm-3 control-label"></label>
	<div class="col-sm-9">
...
<div class="form-group">
	<label for="title" class="col-sm-3 control-label">实验标题</label>
	<div class="col-sm-9">
...
<div class="form-group">
	<label for="content" class="col-sm-3 control-label">实验内容</label>
	<div class="col-sm-9">
			...
			$(document).ready(function() {
				...
				$("#form1").submit(function(e) {
					...
					if ($("#curriculum_id").val() == '') {
						alert("课程id，如果未指定课程，即为该科目共有实验必须输入！");
						$("#curriculum_id").focus();
						return false;
					}
					if ($("#is_actived").val() == '') {
