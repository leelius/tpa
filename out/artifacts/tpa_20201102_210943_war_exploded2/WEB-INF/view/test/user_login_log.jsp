...
<div class="row">
	<c:forEach var="it" items="${list}" varStatus="index">
		<div class="col-xs-12 col-sm-6">
			...
			<div class="col-xs-12 col-sm-12">${it.login_gmt}</div>
				<div class="clearfix"></div>
			...
			<div class="col-xs-12 col-sm-12">${it.operating_system}</div>
				<div class="clearfix"></div>

			<div class="col-xs-12 col-sm-12">${it.browser}</div>
				<div class="clearfix"></div>
...
<div class="form-group">
	<label for="login_gmt" class="col-sm-3 control-label">登录时间</label>
	<div class="col-sm-9">
		<input type="text" class="form-control restrictnumber" id="login_gmt"
			name="login_gmt" placeholder="登录时间">
	</div>
</div>
<div class="form-group">
	<label for="user_ip" class="col-sm-3 control-label">登录IP</label>
	<div class="col-sm-9">
		<input type="text" class="form-control" id="user_ip"
			name="user_ip" placeholder="登录IP">
	</div>
</div>
<!-- selectbox begin -->
<div class="form-group">
...
<!-- radio end -->
<div class="form-group">
	<label for="operating_system" class="col-sm-3 control-label">操作系统</label>
	<div class="col-sm-9">
		<input type="text" class="form-control" id="operating_system"
			name="operating_system" placeholder="操作系统">
	</div>
</div>
<div class="form-group">
	<label for="browser" class="col-sm-3 control-label">浏览器</label>
	<div class="col-sm-9">
		<input type="text" class="form-control" id="browser"
			name="browser" placeholder="浏览器">
	</div>
</div>
...
<div class="form-group">
	...
	<div class="col-sm-9">
		<input type="text" class="form-control restrictnumber" id="login_gmt"
			name="login_gmt" placeholder="登录时间" value="${it.login_gmt}">
	</div>
</div>
<div class="form-group">
	<label for="user_ip" class="col-sm-3 control-label">登录IP</label>
	<div class="col-sm-9">
		<input type="text" class="form-control" id="user_ip"
			name="user_ip" placeholder="登录IP" value="${it.user_ip}">
	</div>
</div>
<!-- selectbox begin -->
<div class="form-group">
...
<div class="form-group">
	...
	<div class="col-sm-9">
		<input type="text" class="form-control" id="operating_system"
			name="operating_system" placeholder="操作系统" value="${it.operating_system}">
	</div>
</div>
<div class="form-group">
	<label for="browser" class="col-sm-3 control-label">浏览器</label>
	<div class="col-sm-9">
		<input type="text" class="form-control" id="browser"
			name="browser" placeholder="浏览器" value="${it.browser}">
	</div>
</div>
<div class="form-group d_t_dater">
	<label for="create_gmt_date" class="col-sm-3 control-label">创建时间</label>
