													...
													<tbody>
														<c:forEach var="it" items="${list}" varStatus="index">
															<tr>
																...
																<td>${it.name}</td>
																<td><img style="width: 100px;" src="${it.logourl}"></td>
																<td><a target="_blank" href="${it.url}">${it.url}</a></td>
																...
																<td>
																	...
																	<button value="${it.id}"
																		class="moveup btn btn-sm btn-info"
																		<c:if test="${index.count==1}">disabled</c:if>>上移</button>
																	<button value="${it.id}"
																		class="movedown btn btn-sm btn-warning"
										...
										<div class="col-xs-12 col-sm-6">
											<div class="row showbd margin-xs">
												...
												<div class="col-xs-12 col-sm-12">
													<img style="width: 100px;" src="${it.logourl}">
												</div>
												<div class="clearfix"></div>
								...
								<div class="panel panel-default">
									...
									<div class="panel-body">
										...
										<form id="form1" class="form-horizontal" method="post"
											...
											<div class="form-group">
												<label for="logo_url" class="col-sm-2 control-label">标志图片</label>
												<div class="col-sm-10">
													<input type="hidden" id="logourl" name="logourl"
														placeholder="标志url" /> <img id="logourl2" src="" alt=""
														width="100" /> <input type="button" id="logo_url_btn"
														value="点击选择标志图片" />（请在已经上传的图片空间中选择，也可以直接给其他图片url，无需指定大小和其他设置！）
												</div>
											</div>
											<div class="form-group">
									...
									<div class="panel-body">
										...
										<form id="form1" class="form-horizontal" method="post"
											...
											<div class="form-group">
												...
												<div class="col-sm-10">
													<input type="hidden" id="logourl" name="logourl"
														value="${it.logourl}" /> <img id="logourl2"
														src="${it.logourl}" alt="" width="100" /> <input
														type="button" id="logo_url_btn" value="点击选择标志图片" />（请在已经上传的图片空间中选择，无需指定大小和其他设置！）
												</div>
											</div>
											<div class="form-group">
												<div class="col-sm-offset-2 col-sm-10">
